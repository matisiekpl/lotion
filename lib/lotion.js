import { defineComponent as ze, h as Kn, resolveComponent as Ma, ref as Ze, onMounted as Aa, onBeforeUnmount as As, getCurrentInstance as up, watchEffect as fp, nextTick as dp, unref as he, shallowRef as hp, markRaw as pp, customRef as mp, computed as bf, watch as wf, openBlock as me, createElementBlock as Ke, createVNode as vt, withKeys as Fl, withModifiers as Mo, createBlock as Br, withCtx as kr, createElementVNode as We, normalizeClass as wt, createCommentVNode as un, toDisplayString as Ao, renderSlot as gp, withDirectives as yp, Fragment as xf, renderList as kf, vShow as vp, resolveDynamicComponent as bp, onBeforeUpdate as wp, mergeProps as xp, TransitionGroup as kp } from "vue";
/*!
...
function It(n) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? xc(Object(t), !0).forEach(function(r) {
      Sp(n, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t)) : xc(Object(t)).forEach(function(r) {
...
var Qt = qt(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), Pi = qt(/Edge/i), kc = qt(/firefox/i), ti = qt(/safari/i) && !qt(/chrome/i) && !qt(/android/i), Sf = qt(/iP(ad|od|hone)/i), Op = qt(/chrome/i) && qt(/android/i), Ef = {
  capture: !1,
  passive: !1
};
function ie(n, e, t) {
  n.addEventListener(e, t, !Qt && Ef);
}
function ne(n, e, t) {
  n.removeEventListener(e, t, !Qt && Ef);
}
function Do(n, e) {
  if (!!e) {
...
function ye(n, e, t, r, i) {
  if (!(!n.getBoundingClientRect && n !== window)) {
    var o, s, l, a, c, u, f;
    if (n !== window && n.parentNode && n !== Dt() ? (o = n.getBoundingClientRect(), s = o.top, l = o.left, a = o.bottom, c = o.right, u = o.height, f = o.width) : (s = 0, l = 0, a = window.innerHeight, c = window.innerWidth, u = window.innerHeight, f = window.innerWidth), (e || t) && n !== window && (i = i || n.parentNode, !Qt))
      do
  ...
  return {
    ...
    animateAll: function(r) {
      ...
      n.forEach(function(l) {
        var a = 0, c = l.target, u = c.fromRect, f = ye(c), d = c.prevFromRect, h = c.prevToRect, p = l.rect, m = vr(c, !0);
        m && (f.top -= m.f, f.left -= m.e), c.toRect = f, c.thisAnimationDuration && Js(d, f) && !Js(u, f) && (p.top - f.top) / (p.left - f.left) === (u.top - f.top) / (u.left - f.left) && (a = Pp(p, d, h, i.options)), Js(f, u) || (c.prevFromRect = u, c.prevToRect = f, a || (a = i.options.animation), i.animate(c, p, f, a)), a && (o = !0, s = Math.max(s, a), clearTimeout(c.animationResetTimer), c.animationResetTimer = setTimeout(function() {
    ...
    animate: function(r, i, o, s) {
      if (s) {
        ...
        var l = vr(this.el), a = l && l.a, c = l && l.d, u = (i.left - o.left) / (a || 1), f = (i.top - o.top) / (c || 1);
...
var or = [], Gs = {
  ...
  mount: function(e) {
    for (var t in Gs)
      Gs.hasOwnProperty(t) && !(t in e) && (e[t] = Gs[t]);
  ...
  initializePlugins: function(e, t, r, i) {
    or.forEach(function(l) {
      ...
      if (!(!e.options[a] && !l.initializeByDefault)) {
        ...
        c.sortable = e, c.options = e.options, e[a] = c, Gt(r, c.defaults);
      }
    });
  ...
  getEventProperties: function(e, t) {
    var r = {};
    return or.forEach(function(i) {
      typeof i.eventProperties == "function" && Gt(r, i.eventProperties.call(t[i.pluginName], e));
    }), r;
  },
  modifyOption: function(e, t, r) {
    var i;
    return or.forEach(function(o) {
...
function Lp(n) {
  ...
  if (e = e || t && t[et], !!e) {
    ...
    window.CustomEvent && !Qt && !Pi ? m = new CustomEvent(r, {
      bubbles: !0,
      cancelable: !0
...
var N, fe, q, ce, In, vo, de, fn, mr, Xe, ri, on, Qi, Ce, ur = !1, No = !1, Io = [], An, yt, Ys, Xs, Tc, Oc, Jr, sr, ii, oi = !1, Zi = !1, bo, De, Qs = [], $l = !1, Ro = [], Ds = typeof document < "u", eo = Sf, Mc = Pi || Qt ? "cssFloat" : "float", _p = Ds && !Op && !Sf && "draggable" in document.createElement("div"), Af = function() {
  if (!!Ds) {
    if (Qt)
      return !1;
  ...
  var r = H(e), i = parseInt(r.width) - parseInt(r.paddingLeft) - parseInt(r.paddingRight) - parseInt(r.borderLeftWidth) - parseInt(r.borderRightWidth), o = Sr(e, 0, t), s = Sr(e, 1, t), l = o && H(o), a = s && H(s), c = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + ye(o).width, u = a && parseInt(a.marginLeft) + parseInt(a.marginRight) + ye(s).width;
  if (r.display === "flex")
...
Ds && document.addEventListener("click", function(n) {
  if (No)
...
function V(n, e) {
  ...
  this.el = n, this.options = e = Gt({}, e), n[et] = this;
  var t = {
    group: null,
    sort: !0,
    disabled: !1,
...
V.prototype = {
  ...
  _onTapStart: function(e) {
    if (!!e.cancelable) {
      ...
      if (Jp(r), !N && !(/mousedown|pointerdown/.test(s) && e.button !== 0 || i.disabled) && !c.isContentEditable && !(!this.nativeDraggable && ti && a && a.tagName.toUpperCase() === "SELECT") && (a = Tt(a, i.draggable, r, !1), !(a && a.animated) && vo !== a)) {
        if (mr = lt(a), ri = lt(a, i.draggable), typeof u == "function") {
  ...
  _prepareDragStart: function(e, t, r) {
    ...
    if (r && !N && r.parentNode === o) {
      ...
      if (ce = o, N = r, fe = N.parentNode, In = N.nextSibling, vo = r, Qi = s.group, V.dragged = N, An = {
        ...
        i._disableDelayedDragEvents(), !kc && i.nativeDraggable && (N.draggable = !0), i._triggerDragStart(e, t), Le({
          sortable: i,
          name: "choose",
          originalEvent: e
        }), Ye(N, s.chosenClass, !0);
      }, s.ignore.split(",").forEach(function(u) {
        Cf(N, u.trim(), Zs);
      }), ie(l, "dragover", Dn), ie(l, "mousemove", Dn), ie(l, "touchmove", Dn), ie(l, "mouseup", i._onDrop), ie(l, "touchend", i._onDrop), ie(l, "touchcancel", i._onDrop), kc && this.nativeDraggable && (this.options.touchStartThreshold = 4, N.draggable = !0), je("delayStart", this, {
        evt: e
      }), s.delay && (!s.delayOnTouchOnly || t) && (!this.nativeDraggable || !(Pi || Qt))) {
        if (V.eventCanceled) {
          this._onDrop();
          return;
        }
  ...
  _disableDelayedDrag: function() {
    N && Zs(N), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents();
  },
  ...
  _dragStarted: function(e, t) {
    if (ur = !1, ce && N) {
      ...
      var r = this.options;
      !e && Ye(N, r.dragClass, !1), Ye(N, r.ghostClass, !0), V.active = this, e && this._appendGhost(), Le({
        sortable: this,
        name: "start",
        originalEvent: t
      });
  ...
  _onTouchMove: function(e) {
    if (An) {
      var t = this.options, r = t.fallbackTolerance, i = t.fallbackOffset, o = e.touches ? e.touches[0] : e, s = q && vr(q, !0), l = q && s && s.a, a = q && s && s.d, c = eo && De && Cc(De), u = (o.clientX - An.clientX + i.x) / (l || 1) + (c ? c[0] - Qs[0] : 0) / (l || 1), f = (o.clientY - An.clientY + i.y) / (a || 1) + (c ? c[1] - Qs[1] : 0) / (a || 1);
      if (!V.active && !ur) {
      ...
      if (q) {
        ...
        H(q, "webkitTransform", d), H(q, "mozTransform", d), H(q, "msTransform", d), H(q, "transform", d), Ys = u, Xs = f, yt = o;
      }
  ...
  _onDragStart: function(e, t) {
    ...
    je("setupClone", this), V.eventCanceled || (de = Mf(N), de.draggable = !1, de.style["will-change"] = "", this._hideClone(), Ye(de, this.options.chosenClass, !1), V.clone = de), r.cloneId = wo(function() {
      je("clone", r), !V.eventCanceled && (r.options.removeCloneOnHide || ce.insertBefore(de, N), r._hideClone(), Le({
        sortable: r,
        name: "clone"
      }));
    }), !t && Ye(N, o.dragClass, !0), t ? (No = !0, r._loopId = setInterval(r._emulateDragOver, 50)) : (ne(document, "mouseup", r._onDrop), ne(document, "touchend", r._onDrop), ne(document, "touchcancel", r._onDrop), i && (i.effectAllowed = "move", o.setData && o.setData.call(r, i, N)), ie(document, "drop", r), H(N, "transform", "translateZ(0)")), ur = !0, r._dragStartId = wo(r._dragStarted.bind(r, t, e)), ie(document, "selectstart", r), Jr = !0, ti && H(document.body, "user-select", "none");
  },
  _onDragOver: function(e) {
    ...
    function w(M) {
      return g("dragOverCompleted", {
        insertion: M
      }), M && (u ? c._hideClone() : c._showClone(p), p !== d && (Ye(N, Ce ? Ce.options.ghostClass : c.options.ghostClass, !1), Ye(N, l.ghostClass, !0)), Ce !== p && p !== V.active ? Ce = p : p === V.active && Ce && (Ce = null), d === p && (p._ignoreWhileAnimating = r), p.animateAll(function() {
        g("dragOverAnimationComplete"), p._ignoreWhileAnimating = null;
      }), p !== d && (d.animateAll(), d._ignoreWhileAnimating = null)), (r === N && !N.animated || r === t && !r.animated) && (sr = null), !l.dragoverBubble && !e.rootEl && r !== document && (N.parentNode[et]._isOutsideThisEl(e.target), !M && Dn(e)), !l.dragoverBubble && e.stopPropagation && e.stopPropagation(), m = !0;
    }
    function E() {
      Xe = lt(N), on = lt(N, l.draggable), Le({
        sortable: p,
        name: "change",
        toEl: t,
        newIndex: Xe,
    ...
    if (No = !1, c && !l.disabled && (u ? f || (s = fe !== ce) : Ce === this || (this.lastPutMode = Qi.checkPull(this, c, N, e)) && a.checkPut(this, c, N, e))) {
      ...
      if (!y || Wp(e, h, this) && !y.animated) {
        ...
        o = ye(r);
        var b = 0, A, _ = N.parentNode !== t, D = !Fp(N.animated && N.toRect || i, r.animated && r.toRect || o, h), $ = h ? "top" : "left", K = Ec(r, "top", "top") || Ec(N, "top", "top"), U = K ? K.scrollTop : void 0;
        sr !== r && (A = o[$], oi = !1, Zi = !D && l.invertSwap || _), b = Up(e, r, o, h, D ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Zi, sr === r);
        var G;
        if (b !== 0) {
          var Y = lt(N);
          do
        ...
        if (b === 0 || G === r)
          return w(!1);
        sr = r, ii = b;
        var re = r.nextElementSibling, x = !1;
        x = b === 1;
        var S = to(ce, t, N, i, r, o, e, x);
        if (S !== !1)
          return (S === 1 || S === -1) && (x = S === 1), $l = !0, setTimeout(Vp, 30), v(), x && !re ? t.appendChild(N) : r.parentNode.insertBefore(N, x ? re : r), K && Of(K, 0, U - K.scrollTop), fe = N.parentNode, A !== void 0 && !Zi && (bo = Math.abs(A - ye(r)[$])), E(), w(!0);
      }
      if (t.contains(N))
        return w(!1);
    }
  ...
  _onDrop: function(e) {
    ...
    ur = !1, Zi = !1, oi = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), zl(this.cloneId), zl(this._dragStartId), this.nativeDraggable && (ne(document, "drop", this), ne(t, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), ti && H(document.body, "user-select", ""), H(N, "transform", ""), e && (Jr && (e.cancelable && e.preventDefault(), !r.dropBubble && e.stopPropagation()), q && q.parentNode && q.parentNode.removeChild(q), (ce === fe || Ce && Ce.lastPutMode !== "clone") && de && de.parentNode && de.parentNode.removeChild(de), N && (this.nativeDraggable && ne(N, "dragend", this), Zs(N), N.style["will-change"] = "", Jr && !ur && Ye(N, Ce ? Ce.options.ghostClass : this.options.ghostClass, !1), Ye(N, this.options.chosenClass, !1), Le({
      ...
      toEl: fe,
      originalEvent: e
    })), V.active && ((Xe == null || Xe === -1) && (Xe = mr, on = ri), Le({
      sortable: this,
      name: "end",
      toEl: fe,
      originalEvent: e
  ...
  _nulling: function() {
    je("nulling", this), ce = N = fe = q = In = de = vo = fn = An = yt = Jr = Xe = on = mr = ri = sr = ii = Ce = Qi = V.dragged = V.ghost = V.clone = V.active = null, Ro.forEach(function(e) {
      e.checked = !0;
    }), Ro.length = Ys = Xs = 0;
  },
...
function to(n, e, t, r, i, o, s, l) {
  ...
  return window.CustomEvent && !Qt && !Pi ? a = new CustomEvent("move", {
    bubbles: !0,
    cancelable: !0
...
Ds && ie(document, "touchmove", function(n) {
  (V.active || ur) && n.cancelable && n.preventDefault();
});
V.utils = {
  on: ie,
  off: ne,
...
function Gp() {
  ...
  return n.prototype = {
    ...
    drop: function() {
      this.sortable.nativeDraggable ? ne(document, "dragover", this._handleAutoScroll) : (ne(document, "pointermove", this._handleFallbackAutoScroll), ne(document, "touchmove", this._handleFallbackAutoScroll), ne(document, "mousemove", this._handleFallbackAutoScroll)), Ac(), xo(), Np();
    },
    nulling: function() {
      Po = Hl = Gr = Vl = Yr = el = tl = null, pe.length = 0;
    },
    ...
    _handleAutoScroll: function(t, r) {
      ...
      if (Po = t, r || this.options.forceAutoScrollFallback || Pi || Qt || ti) {
        nl(t, this.options, l, r);
        var a = pn(l, !0);
        Vl && (!Yr || o !== el || s !== tl) && (Yr && Ac(), Yr = setInterval(function() {
          var c = pn(document.elementFromPoint(o, s), !0);
          c !== a && (a = c, xo()), nl(t, i.options, c, r);
        }, 10), el = o, tl = s);
      } else {
...
var nl = Tf(function(n, e, t, r) {
  if (!!e.scroll) {
    var i = (n.touches ? n.touches[0] : n).clientX, o = (n.touches ? n.touches[0] : n).clientY, s = e.scrollSensitivity, l = e.scrollSpeed, a = Dt(), c = !1, u;
    Hl !== t && (Hl = t, xo(), Gr = e.scroll, u = e.scrollFn, Gr === !0 && (Gr = pn(t, !0)));
    var f = 0, d = Gr;
    do {
      var h = d, p = ye(h), m = p.top, g = p.bottom, v = p.left, w = p.right, E = p.width, y = p.height, T = void 0, b = void 0, A = h.scrollWidth, _ = h.scrollHeight, D = H(h), $ = h.scrollLeft, K = h.scrollTop;
      h === a ? (T = E < A && (D.overflowX === "auto" || D.overflowX === "scroll" || D.overflowX === "visible"), b = y < _ && (D.overflowY === "auto" || D.overflowY === "scroll" || D.overflowY === "visible")) : (T = E < A && (D.overflowX === "auto" || D.overflowX === "scroll"), b = y < _ && (D.overflowY === "auto" || D.overflowY === "scroll"));
      var U = T && (Math.abs(w - i) <= s && $ + E < A) - (Math.abs(v - i) <= s && !!$), G = b && (Math.abs(g - o) <= s && K + y < _) - (Math.abs(m - o) <= s && !!K);
      if (!pe[f])
        for (var Y = 0; Y <= f; Y++)
          pe[Y] || (pe[Y] = {});
      (pe[f].vx != U || pe[f].vy != G || pe[f].el !== h) && (pe[f].el = h, pe[f].vx = U, pe[f].vy = G, clearInterval(pe[f].pid), (U != 0 || G != 0) && (c = !0, pe[f].pid = setInterval(function() {
        ...
        var re = pe[this.layer].vy ? pe[this.layer].vy * l : 0, x = pe[this.layer].vx ? pe[this.layer].vx * l : 0;
        typeof u == "function" && u.call(V.dragged.parentNode[et], x, re, n, Po, pe[this.layer].el) !== "continue" || Of(pe[this.layer].el, x, re);
      }.bind({
        layer: f
      }), 24))), f++;
...
Na.prototype = {
  ...
  onSpill: function(e) {
    ...
    var i = Sr(this.sortable.el, this.startIndex, this.options);
...
const jl = ["Start", "Add", "Remove", "Update", "End"], Wl = ["Choose", "Unchoose", "Sort", "Filter", "Clone"], sm = ["Move", ...jl, ...Wl].map((n) => "on" + n);
let il = null;
const lm = {
  options: Object,
  list: {
  ...
  methods: {
    getTag() {
      return this.component ? Ma(this.component) : this.tag;
    },
    updateOptions(n) {
      for (var e in n) {
        const t = Dc(e);
    ...
    onDragStart(n) {
      this.computeIndexes(), this.context = this.getUnderlyingVm(n.item), this.context && (n.item._underlying_vm_ = this.clone(this.context.element), il = n.item);
    },
    onDragAdd(n) {
    ...
    onDragUpdate(n) {
      rl(n.item), Nc(n.from, n.item, n.oldIndex);
    ...
    computeFutureIndex(n, e) {
      ...
      return t.indexOf(il) !== -1 || !e.willInsertAfter ? i : i + 1;
    }
  }
});
...
var Ee = [];
for (var ol = 0; ol < 256; ++ol)
  Ee.push((ol + 256).toString(16).substr(1));
function hm(n) {
...
function ro(n, e) {
  return sl.index = n, sl.offset = e, sl;
}
function Lo(n, e) {
  if (n === e)
    return !0;
...
function Vf(n, e, t, r, i) {
  let o = n.depth > i && Ul(n, e, i + 1), s = r.depth > i && Ul(t, r, i + 1), l = [];
...
class zo {
  ...
  create(e = null, t, r) {
    ...
    return new xt(this, this.computeAttrs(e), C.from(t), oe.setFrom(r));
  }
  createChecked(e = null, t, r) {
    return t = C.from(t), this.checkContent(t), new xt(this, this.computeAttrs(e), t, oe.setFrom(r));
  }
  createAndFill(e = null, t, r) {
    ...
    return o ? new xt(this, e, t.append(o), oe.setFrom(r)) : null;
  }
  validContent(e) {
...
class Ns {
  ...
  static compile(e, t) {
    ...
    return e.forEach((o, s) => r[o] = new Ns(o, i++, t, s)), r;
  }
  removeFromSet(e) {
...
class Yf {
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = Te.from(e.nodes), t.marks = Te.from(e.marks || {}), this.nodes = zo.compile(this.spec.nodes, this), this.marks = Ns.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
...
const Xf = {
  ...
  style: !0,
  title: !0
}, Qf = { ol: !0, ul: !0 }, wi = 1, Kl = 2, li = 4;
function Bc(n, e, t) {
  return e != null ? (e ? wi : 0) | (e === "full" ? Kl : 0) : n && n.whitespace == "pre" ? wi | Kl : t & ~li;
}
class io {
...
class _c {
  ...
  addTextNode(e, t) {
    let r = e.nodeValue, i = this.top, o = i.options & Kl ? "full" : this.localPreserveWS || (i.options & wi) > 0;
  ...
  insertNode(e, t) {
    ...
    if (r) {
      ...
      for (let s of r.concat(e.marks))
        (i.type ? i.type.allowsMarkType(s.type) : $c(s.type, e.type)) && (o = s.addToSet(o));
...
class Qn {
  ...
  serializeFragment(e, t = {}, r) {
    r || (r = ll(t).createDocumentFragment());
    let i = r, o = [];
    return e.forEach((s) => {
  ...
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: i } = ko(ll(t), this.nodes[e.type.name](e), null, e.attrs);
    if (i) {
      if (e.isLeaf)
  ...
  serializeMark(e, t, r = {}) {
    ...
    return i && ko(ll(r), i(e, t), null, e.attrs);
  }
...
function ko(n, e, t, r) {
  ...
  for (let f = u; f < e.length; f++) {
    ...
    if (d === 0) {
      ...
      let { dom: h, contentDOM: p } = ko(n, d, t, r);
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= f) {
        ...
        return (t < 0 ? e != a : e != f) && (m |= rd), new ql(h, m, p);
      }
      i += u - c;
    }
...
class Re {
  ...
  static jsonID(e, t) {
    ...
    return al[e] = t, t.prototype.jsonID = e, t;
  }
}
class ge {
  constructor(e, t) {
...
function Ra(n, e, t) {
  ...
  for (let i = 0; i < n.childCount; i++) {
    let o = n.child(i);
    o.content.size && (o = o.copy(Ra(o.content, e, o))), o.isInline && (o = e(o, t, i)), r.push(o);
  }
...
class mn extends Re {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), o = new R(Ra(t.content, (s, l) => !s.isAtom || !l.type.allowsMarkType(this.mark.type) ? s : s.mark(this.mark.addToSet(s.marks)), i), t.openStart, t.openEnd);
...
class Mt extends Re {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = new R(Ra(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), t.openStart, t.openEnd);
...
Re.jsonID("removeNodeMark", Er);
class be extends Re {
  constructor(e, t, r, i = !1) {
    super(), this.from = e, this.to = t, this.slice = r, this.structure = i;
  }
  apply(e) {
    return this.structure && Jl(e, this.from, this.to) ? ge.fail("Structure replace would overwrite content") : ge.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
function Pa(n, e, t, r = t.contentMatch, i = !0) {
...
function qm(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    ...
    if (s.isTextblock && !s.hasMarkup(r, a) && Jm(n.doc, n.mapping.slice(o).map(l), r)) {
      ...
      c === !1 && sd(n, s, l, o), Pa(n, n.mapping.slice(o).map(l, 1), r, void 0, c === null);
...
function Qm(n, e, t) {
  ...
  s.inlineContent && Pa(n, e + t - 1, s, o.node().contentMatchAt(o.index()), r == null);
...
class tg {
  ...
  openMore() {
    let { content: e, openStart: t, openEnd: r } = this.unplaced, i = cl(e, t);
  ...
  mustMoveInline() {
    ...
    if (!e.type.isTextblock || !ul(this.$to, this.$to.depth, e.type, e.match, !1) || this.$to.depth == this.depth && (t = this.findCloseLevel(this.$to)) && t.depth == this.depth)
      return -1;
  ...
  findCloseLevel(e) {
    e:
      for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
        let { match: r, type: i } = this.frontier[t], o = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), s = ul(e, t, i, r, o);
        if (!!s) {
          for (let l = t - 1; l >= 0; l--) {
            let { match: a, type: c } = this.frontier[l], u = ul(e, l, c, a, !0);
            if (!u || u.childCount)
              continue e;
          }
...
class wr extends Re {
  ...
  map(e) {
    let t = e.mapResult(this.pos, 1);
    return t.deletedAfter ? null : new wr(t.pos, this.attr, this.value);
  }
  toJSON() {
  ...
  static fromJSON(e, t) {
    ...
    return new wr(t.pos, t.attr, t.value);
  }
}
Re.jsonID("attr", wr);
class ki extends Re {
  ...
  static fromJSON(e, t) {
    ...
    return new ki(t.attr, t.value);
  }
}
Re.jsonID("docAttr", ki);
...
class dd {
  ...
  setNodeAttribute(e, t, r) {
    return this.step(new wr(e, t, r)), this;
  }
  setDocAttribute(e, t) {
    return this.step(new ki(e, t)), this;
  }
  addNodeMark(e, t) {
  ...
  removeNodeMark(e, t) {
    ...
    return this.step(new Er(e, t)), this;
  }
  split(e, t = 1, r) {
...
class Z {
  ...
  static findFrom(e, t, r = !1) {
    let i = e.parent.inlineContent ? new X(e) : fr(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (i)
      return i;
    for (let o = e.depth - 1; o >= 0; o--) {
      let s = t < 0 ? fr(e.node(0), e.node(o), e.before(o + 1), e.index(o), t, r) : fr(e.node(0), e.node(o), e.after(o + 1), e.index(o) + 1, t, r);
      if (s)
        return s;
    }
    return null;
  ...
  static atStart(e) {
    return fr(e, e, 0, 0, 1) || new ft(e);
  }
  static atEnd(e) {
    return fr(e, e, e.content.size, e.childCount, -1) || new ft(e);
  }
  static fromJSON(e, t) {
    if (!t || !t.type)
  ...
  static jsonID(e, t) {
    ...
    return fl[e] = t, t.prototype.jsonID = e, t;
  }
  getBookmark() {
...
function fr(n, e, t, r, i, o = !1) {
  ...
  for (let s = r - (i > 0 ? 0 : 1); i > 0 ? s < e.childCount : s >= 0; s += i) {
    ...
    if (l.isAtom) {
      ...
      let a = fr(n, l, t + i, i < 0 ? l.childCount : 0, i, o);
      if (a)
        return a;
    }
    t += l.nodeSize * i;
...
class gr {
  ...
  static create(e) {
    let t = new dl(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new gr(t);
    for (let i = 0; i < t.fields.length; i++)
      r[t.fields[i].name] = t.fields[i].init(e, r);
    return r;
  }
  reconfigure(e) {
    let t = new dl(this.schema, e.plugins), r = t.fields, i = new gr(t);
    for (let o = 0; o < r.length; o++) {
      let s = r[o].name;
  ...
  static fromJSON(e, t, r) {
    ...
    let i = new dl(e.schema, e.plugins), o = new gr(i);
    return i.fields.forEach((s) => {
      if (s.name == "doc")
        o.doc = xt.fromJSON(e.schema, t.doc);
...
const jt = function(n, e, t) {
  let r = Gl || (Gl = document.createRange());
...
const Rt = typeof navigator < "u" ? navigator : null, Xc = typeof document < "u" ? document : null, Sn = Rt && Rt.userAgent || "", Yl = /Edge\/(\d+)/.exec(Sn), md = /MSIE \d/.exec(Sn), Xl = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Sn), qe = !!(md || Xl || Yl), bn = md ? document.documentMode : Xl ? +Xl[1] : Yl ? +Yl[1] : 0, kt = !qe && /gecko\/(\d+)/i.test(Sn);
kt && +(/Firefox\/(\d+)/.exec(Sn) || [0, 0])[1];
const Ql = !qe && /Chrome\/(\d+)/.exec(Sn), Ie = !!Ql, gd = Ql ? +Ql[1] : 0, Be = !qe && !!Rt && /Apple Computer/.test(Rt.vendor), Or = Be && (/Mobile\/\w+/.test(Sn) || !!Rt && Rt.maxTouchPoints > 2), at = Or || (Rt ? /Mac/.test(Rt.platform) : !1), vg = Rt ? /Win/.test(Rt.platform) : !1, Ut = /Android \d/.test(Sn), _i = !!Xc && "webkitFontSmoothing" in Xc.documentElement.style, bg = _i ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function wg(n) {
...
function Qc(n, e, t) {
  ...
  for (let s = t || n.dom; s; ) {
    ...
    let l = s, a = l == o.body, c = a ? wg(o) : xg(l), u = 0, f = 0;
...
const Dg = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function xd(n, e, t) {
  let { node: r, offset: i, atom: o } = n.docView.domFromPos(e, t < 0 ? -1 : 1), s = _i || kt;
  if (r.nodeType == 3)
    if (s && (Dg.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = rn(jt(r, i, i), t);
      if (kt && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = rn(jt(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let u = rn(jt(r, i, i + 1), -1);
          if (u.top != a.top)
      ...
      return t < 0 && !i ? (c++, u = -1) : t >= 0 && i == r.nodeValue.length ? (a--, u = 1) : t < 0 ? a-- : c++, Ur(rn(jt(r, a, c), u), u < 0);
    }
  if (!n.state.doc.resolve(e - (o || 0)).parent.inlineContent) {
    if (o == null && i && (t < 0 || i == ct(r))) {
      let a = r.childNodes[i - 1];
      if (a.nodeType == 1)
        return pl(a.getBoundingClientRect(), !1);
    }
    if (o == null && i < ct(r)) {
      let a = r.childNodes[i];
      if (a.nodeType == 1)
        return pl(a.getBoundingClientRect(), !0);
    }
    return pl(r.getBoundingClientRect(), t >= 0);
  }
  if (o == null && i && (t < 0 || i == ct(r))) {
  ...
  return Ur(rn(r.nodeType == 3 ? jt(r) : r, -t), t >= 0);
}
function Ur(n, e) {
  if (n.width == 0)
    return n;
...
function Rg(n, e, t) {
  ...
  return l ? !Ig.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : kd(n, e, () => {
...
`), f && p == h.nodeValue.length)
    ...
    if (kt && u.focusNode && u.focusNode != a.node && u.focusNode.nodeType == 1) {
      let h = u.focusNode.childNodes[u.focusOffset];
      h && h.contentEditable == "false" && (i = !0);
    }
    if (!(i || f && Be) && Jn(l.node, l.offset, u.anchorNode, u.anchorOffset) && Jn(a.node, a.offset, u.focusNode, u.focusOffset))
      return;
    let d = !1;
    if ((c.extend || e == t) && !f) {
...
class Gn extends Fi {
  ...
  static create(e, t, r, i) {
    ...
    return (!s || !s.dom) && (s = Qn.renderSpec(document, t.type.spec.toDOM(t, r), null, t.attrs)), new Gn(e, t, s.dom, s.contentDOM || s.dom, s);
  }
  parseRule() {
  ...
  slice(e, t, r) {
    let i = Gn.create(this.parent, this.mark, !0, r), o = this.children, s = this.size;
    t < s && (o = ea(o, t, s, r)), e > 0 && (o = ea(o, 0, e, r));
...
class wn extends Fi {
  ...
  static create(e, t, r, i, o, s) {
    ...
    if (t.isText) {
      ...
      u || ({ dom: u, contentDOM: f } = Qn.renderSpec(document, t.type.spec.toDOM(t), null, t.attrs));
    !f && !t.isText && u.nodeName != "BR" && (u.hasAttribute("contenteditable") || (u.contentEditable = "false"), t.type.spec.draggable && (u.draggable = !0));
    let d = u;
    return u = Od(u, r, t), c ? a = new Bg(e, t, r, i, u, f || null, d, c, o, s + 1) : t.isText ? new Bs(e, t, r, i, u, d, o) : new wn(e, t, r, i, u, f || null, d, o, s + 1);
  }
  parseRule() {
  ...
  protectLocalComposition(e, { node: t, pos: r, text: i }) {
    ...
    e.input.compositionNodes.push(s), this.children = ea(this.children, r, r + i.length, e, s);
  }
  update(e, t, r, i) {
  ...
  updateOuterDeco(e) {
    ...
    this.dom = Td(this.dom, this.nodeDOM, Zl(this.outerDeco, this.node, t), Zl(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
  selectNode() {
...
class Bs extends wn {
  ...
  slice(e, t, r) {
    ...
    return new Bs(this.parent, i, this.outerDeco, this.innerDeco, o, o, r);
  }
  markDirty(e, t) {
...
function Od(n, e, t) {
  return Td(n, n, Fn, Zl(e, t, n.nodeType != 1));
}
function Ho(n, e) {
  if (n.length != e.length)
    return !1;
  ...
  syncToMarks(e, t, r) {
    ...
    for (; o < e.length; ) {
      ...
      if (l > -1)
        ...
        let a = Gn.create(this.top, e[o], t, r);
...
function Ug(n) {
  ...
  i ? t.setStart(r.parentNode, Oe(r) + 1) : t.setStart(r, 0), t.collapse(!0), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && qe && bn <= 11 && (r.disabled = !0, r.disabled = !1);
}
function Ad(n, e) {
  if (e instanceof z) {
...
function fu(n, e, t) {
  ...
  if (r instanceof X)
    if (t.indexOf("s") > -1) {
      ...
      return sn(n, new X(r.$anchor, s));
    } else if (r.empty) {
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        let i = ta(n.state, e);
        return i && i instanceof z ? sn(n, i) : !1;
      } else if (!(at && t.indexOf("m") > -1)) {
        let i = r.$head, o = i.textOffset ? null : e < 0 ? i.nodeBefore : i.nodeAfter, s;
        if (!o || o.isText)
          return !1;
        let l = e < 0 ? i.pos - o.nodeSize : i.pos;
        return o.isAtom || (s = n.docView.descAt(l)) && !s.contentDOM ? z.isSelectable(o) ? sn(n, new z(e < 0 ? n.state.doc.resolve(i.pos - o.nodeSize) : i)) : _i ? sn(n, new X(n.state.doc.resolve(e < 0 ? l : l + o.nodeSize))) : !1 : !1;
      }
    } else
      return !1;
  else {
    if (r instanceof z && r.node.isInline)
      return sn(n, new X(e > 0 ? r.$to : r.$from));
    {
      let i = ta(n.state, e);
      return i ? sn(n, i) : !1;
    }
...
function qg(n) {
  ...
  if (!t)
    return;
  let i, o, s = !1;
  for (kt && t.nodeType == 1 && r < Vo(t) && ci(t.childNodes[r], -1) && (s = !0); ; )
    if (r > 0) {
      if (t.nodeType != 1)
        break;
      {
...
function $a(n, e) {
  ...
  let s = n.someProp("clipboardSerializer") || Qn.fromSchema(n.state.schema), l = _d(), a = l.createElement("div");
...
`))), 0, 0) : R.empty;
    ...
    if (f)
      ...
      let d = i.marks(), { schema: h } = n.state, p = Qn.fromSchema(h);
...
function ra(n, e, t, r, i, o) {
  let s = e < 0 ? n.firstChild : n.lastChild, l = s.content;
  return n.childCount > 1 && (o = 0), i < r - 1 && (l = ra(l, e, t, r, i + 1, o)), i >= t && (l = e < 0 ? s.contentMatchAt(0).fillBefore(l, o <= i).append(l) : l.append(s.contentMatchAt(s.childCount).fillBefore(C.empty, !0))), n.replaceChild(e < 0 ? 0 : n.childCount - 1, s.copy(l));
}
function gu(n, e, t) {
  return e < n.openStart && (n = new R(ra(n.content, -1, e, n.openStart, 0, n.openEnd), e, n.openEnd)), t < n.openEnd && (n = new R(ra(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)), n;
}
const Bd = {
  thead: ["table"],
  tbody: ["table"],
...
function ny(n) {
  ...
  return e ? (gl || (gl = e.createPolicy("ProseMirrorClipboard", { createHTML: (t) => t })), gl.createHTML(n)) : n;
}
function ry(n) {
  let e = /^(\s*<meta [^>]*>)*/.exec(n);
...
function ay(n) {
  for (let e in _e) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      uy(n, r) && !za(n, r) && (n.editable || !(r.type in Fe)) && t(n, r);
    }, sy[e] ? { passive: !0 } : void 0);
  }
  Be && n.dom.addEventListener("input", () => null), ia(n);
}
function yn(n, e) {
...
function fy(n, e) {
  !za(n, e) && _e[e.type] && (n.editable || !(e.type in Fe)) && _e[e.type](n, e);
}
Fe.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !$d(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Ut && Ie && t.keyCode == 13)))
...
function my(n, e, t, r, i) {
  return Ha(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? py(n, t) : hy(n, t));
}
function gy(n, e, t, r) {
  return Ha(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function yy(n, e, t, r) {
  return Ha(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || vy(n, t, r);
}
function vy(n, e, t) {
  if (t.button != 0)
    return !1;
...
_e.mousedown = (n, e) => {
  ...
  let r = Va(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && dy(t, n.input.lastClick) && !t[Fd] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(_s(t));
...
_e.touchstart = (n) => {
  n.input.lastTouch = Date.now(), Va(n), yn(n, "pointer");
};
_e.touchmove = (n) => {
  n.input.lastTouch = Date.now(), yn(n, "pointer");
};
_e.contextmenu = (n) => Va(n);
function $d(n, e) {
...
Fe.compositionstart = Fe.compositionupdate = (n) => {
  if (!n.composing) {
    ...
    else if (jo(n, !e.selection.empty), kt && e.selection.empty && t.parentOffset && !t.textOffset && t.nodeBefore.marks.length) {
...
function Hd(n) {
  for (n.composing && (n.input.composing = !1, n.input.compositionEndedAt = ky()); n.input.compositionNodes.length > 0; )
...
function jo(n, e = !1) {
  if (!(Ut && n.domObserver.flushingSoon >= 0)) {
...
const Si = qe && bn < 15 || Or && bg < 604;
_e.copy = Fe.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Si ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = $a(n, s);
...
const Wd = at ? "altKey" : "ctrlKey";
_e.dragstart = (n, e) => {
  let t = e, r = n.input.mouseDown;
  if (r && r.done(), !t.dataTransfer)
    return;
  let i = n.state.selection, o = i.empty ? null : n.posAtCoords(_s(t)), s;
  ...
  let l = (s || n.state.selection).content(), { dom: a, text: c, slice: u } = $a(n, l);
  (!t.dataTransfer.files.length || !Ie || gd > 120) && t.dataTransfer.clearData(), t.dataTransfer.setData(Si ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Si || t.dataTransfer.setData("text/plain", c), n.dragging = new jd(u, !t[Wd], s);
};
_e.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
Fe.drop = (n, e) => {
  ...
  if (f && z.isSelectable(s.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(s.content.firstChild))
    ...
    c.mapping.maps[c.mapping.maps.length - 1].forEach((m, g, v, w) => p = w), c.setSelection(Fa(n, h, c.doc.resolve(p)));
  }
  n.focus(), n.dispatch(c.setMeta("uiEvent", "drop"));
};
_e.focus = (n) => {
  n.input.lastFocus = Date.now(), n.focused || (n.domObserver.stop(), n.dom.classList.add("ProseMirror-focused"), n.domObserver.start(), n.focused = !0, setTimeout(() => {
    n.docView && n.hasFocus() && !n.domObserver.currentSelection.eq(n.domSelectionRange()) && Jt(n);
  }, 20));
};
_e.blur = (n, e) => {
  let t = e;
...
_e.beforeinput = (n, e) => {
  if (Ie && Ut && e.inputType == "deleteContentBackward") {
...
class xn {
  ...
  eq(e) {
    return this == e || e instanceof xn && Ci(this.attrs, e.attrs) && Ci(this.spec, e.spec);
  }
  static is(e) {
...
class ja {
  ...
  eq(e) {
    return this == e || e instanceof ja && Ci(this.attrs, e.attrs) && Ci(this.spec, e.spec);
  }
  destroy() {
  }
}
class ut {
  ...
  static inline(e, t, r, i) {
    return new ut(e, t, new xn(r, i));
  }
  static node(e, t, r, i) {
    return new ut(e, t, new ja(r, i));
  }
  get spec() {
...
class ve {
  ...
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? Ty(this.children, s || [], e, t, r, i, o) : s ? new ve(s.sort(jn), dr) : Ne;
  }
  add(e, t) {
...
function Ty(n, e, t, r, i, o, s) {
  ...
  if (a) {
    let c = Oy(l, n, e, t, i, o, s), u = Uo(c, r, 0, s);
    e = u.local;
...
class Ny {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new Dy(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      qe && bn <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, My)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  onSelectionChange() {
    if (!!uu(this.view)) {
      if (this.suppressingSelectionUpdates)
        return Jt(this.view);
      if (qe && bn <= 11 && !this.view.state.selection.empty) {
  ...
  flush() {
    ...
    if (kt && a.length) {
      ...
      if (u.length == 2) {
        ...
        for (let d of u) {
          let h = d.parentNode;
          h && h.nodeName == "LI" && (!f || Py(e, f) != h) && d.remove();
        }
      }
    }
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && Ls(r) && (c = _a(e)) && c.eq(Z.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Jt(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), Iy(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Jt(e), this.currentSelection.set(r));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (qe && bn <= 11 && e.addedNodes.length)
        for (let u = 0; u < e.addedNodes.length; u++) {
...
function Iy(n) {
  if (!bu.has(n) && (bu.set(n, null), ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(n.dom).whiteSpace) !== -1)) {
    if (n.requiresGeckoHackNode = kt, wu)
      return;
...
function xu(n, e) {
  ...
  return Jn(s.node, s.offset, i, o) && ([t, r, i, o] = [i, o, t, r]), { anchorNode: t, anchorOffset: r, focusNode: i, focusOffset: o };
}
function Ry(n, e) {
  ...
  return n.dom.addEventListener("beforeinput", r, !0), document.execCommand("indent"), n.dom.removeEventListener("beforeinput", r, !0), t ? xu(n, t) : null;
}
function Py(n, e) {
...
function Ly(n, e, t) {
  ...
  if (u && n.dom.contains(u.nodeType == 1 ? u : u.parentNode) && (c = [{ node: u, offset: a.anchorOffset }], Ls(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), Ie && n.input.lastKeyCode === 8)
    for (let g = o; g > i; g--) {
...
function Fy(n, e, t, r, i) {
  ...
  if (n.input.compositionPendingChanges = 0, e < 0) {
    let D = n.input.lastSelectionTime > Date.now() - 50 ? n.input.lastSelectionOrigin : null, $ = _a(n, D);
    if ($ && !n.state.selection.eq($)) {
      if (Ie && Ut && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", (U) => U(n, Pn(13, "Enter"))))
        return;
      let K = n.state.tr.setSelection($);
      D == "pointer" ? K.setMeta("pointer", !0) : D == "key" && K.scrollIntoView(), o && K.setMeta("composition", o), n.dispatch(K);
    }
    return;
  }
  let s = n.state.doc.resolve(e), l = s.sharedDepth(t);
  e = s.before(l + 1), t = n.state.doc.resolve(t).after(l + 1);
  let a = n.state.selection, c = Ly(n, e, t), u = n.state.doc, f = u.slice(c.from, c.to), d, h;
  ...
  let p = Hy(f.content, c.doc.content, c.from, d, h);
  if (p && n.input.domChangeCount++, (Or && n.input.lastIOSEnter > Date.now() - 225 || Ut) && i.some((D) => D.nodeType == 1 && !_y.test(D.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (D) => D(n, Pn(13, "Enter")))) {
  ...
  if (!p)
    if (r && a instanceof X && !a.empty && a.$head.sameParent(a.$anchor) && !n.composing && !(c.sel && c.sel.anchor != c.sel.head))
      ...
      if (c.sel) {
        let D = ku(n, n.state.doc, c.sel);
        if (D && !D.eq(n.state.selection)) {
          let $ = n.state.tr.setSelection(D);
          o && $.setMeta("composition", o), n.dispatch($);
        }
      }
      return;
    }
  n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof X && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), qe && bn <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == " \xA0" && (p.start--, p.endA--, p.endB--);
  ...
  if ((Or && n.input.lastIOSEnter > Date.now() - 225 && (!w || i.some((D) => D.nodeName == "DIV" || D.nodeName == "P")) || !w && m.pos < c.doc.content.size && !m.sameParent(g) && (E = Z.findFrom(c.doc.resolve(m.pos + 1), 1, !0)) && E.head == g.pos) && n.someProp("handleKeyDown", (D) => D(n, Pn(13, "Enter")))) {
    n.input.lastIOSEnter = 0;
    return;
  }
  if (n.state.selection.anchor > p.start && zy(u, p.start, p.endA, m, g) && n.someProp("handleKeyDown", (D) => D(n, Pn(8, "Backspace")))) {
    Ut && Ie && n.domObserver.suppressSelectionUpdates();
    return;
  }
  Ie && p.endB == p.start && (n.input.lastChromeDelete = Date.now()), Ut && !w && m.start() != g.start() && g.parentOffset == 0 && m.depth == g.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, g = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
    n.someProp("handleKeyDown", function(D) {
      return D(n, Pn(13, "Enter"));
    });
  }, 20));
  let y = p.start, T = p.endA, b, A, _;
  if (w) {
    if (m.pos == g.pos)
      qe && bn <= 11 && m.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => Jt(n), 20)), b = n.state.tr.delete(y, T), A = u.resolve(p.start).marksAcross(u.resolve(p.endA));
    else if (p.endA == p.endB && (_ = $y(m.parent.content.cut(m.parentOffset, g.parentOffset), v.parent.content.cut(v.parentOffset, p.endA - v.start()))))
      b = n.state.tr, _.type == "add" ? b.addMark(y, T, _.mark) : b.removeMark(y, T, _.mark);
    else if (m.parent.child(m.index()).isText && m.index() == g.index() - (g.textOffset ? 0 : 1)) {
      let D = m.parent.textBetween(m.parentOffset, g.parentOffset);
      if (n.someProp("handleTextInput", ($) => $(n, y, T, D)))
        return;
      b = n.state.tr.insertText(D, y, T);
    }
  }
  if (b || (b = n.state.tr.replace(y, T, c.doc.slice(p.start - c.from, p.endB - c.from))), c.sel) {
    let D = ku(n, b.doc, c.sel);
    D && !(Ie && n.composing && D.empty && (p.start != p.endB || n.input.lastChromeDelete < Date.now() - 100) && (D.head == y || D.head == b.mapping.map(T) - 1) || qe && D.empty && D.head == y) && b.setSelection(D);
  }
  A && b.ensureMarks(A), o && b.setMeta("composition", o), n.dispatch(b.scrollIntoView());
}
function ku(n, e, t) {
  return Math.max(t.anchor, t.head) > e.content.size ? null : Fa(n, e.resolve(t.anchor), e.resolve(t.head));
}
function $y(n, e) {
...
function zy(n, e, t, r, i) {
  if (t - e <= i.pos - r.pos || vl(r, !0, !1) < i.pos)
    return !1;
  let o = n.resolve(e);
  if (!r.parent.isTextblock) {
    let l = o.nodeAfter;
  ...
  if (o.parentOffset < o.parent.content.size || !o.parent.isTextblock)
    return !1;
  let s = n.resolve(vl(o, !0, !0));
  return !s.parent.isTextblock || s.pos > t || vl(s, !0, !1) < t ? !1 : r.parent.content.cut(r.parentOffset).eq(s.parent.content);
}
function vl(n, e, t) {
...
class Vy {
  ...
  updateStateInner(e, t) {
    ...
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Ou(this);
      Wy(h, this.nodeViews) && (this.nodeViews = h, o = !0);
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && ia(this), this.editable = Tu(this), Cu(this);
    let a = yl(this), c = Eu(this), u = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", f = o || !this.docView.matchesNode(e.doc, c, a);
    (f || !e.selection.eq(i.selection)) && (s = !0);
    let d = u == "preserve" && s && this.dom.style.overflowAnchor == null && kg(this);
    if (s) {
      this.domObserver.stop();
      let h = f && (qe || Ie) && !this.composing && !i.selection.empty && !e.selection.empty && jy(i.selection, e.selection);
      if (f) {
        let p = Ie ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = xy(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = iu(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && Kg(this)) ? Jt(this, h) : (Ad(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
  ...
  focus() {
    this.domObserver.stop(), this.editable && Eg(this.dom), Jt(this), this.domObserver.start();
  }
  get root() {
    let e = this._root;
    if (e == null) {
  ...
  destroy() {
    !this.docView || (cy(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], yl(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, fg());
  }
  get isDestroyed() {
  ...
  domSelectionRange() {
    ...
    return e ? Be && this.root.nodeType === 11 && gg(this.dom.ownerDocument) == this.dom && Ry(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  domSelection() {
...
var kn = {
  ...
  221: "}",
  222: '"'
}, Uy = typeof navigator < "u" && /Mac/.test(navigator.platform), Ky = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var Me = 0; Me < 10; Me++)
  kn[48 + Me] = kn[96 + Me] = String(Me);
for (var Me = 1; Me <= 24; Me++)
  kn[Me + 111] = "F" + Me;
for (var Me = 65; Me <= 90; Me++)
  kn[Me] = String.fromCharCode(Me + 32), Ko[Me] = String.fromCharCode(Me);
for (var bl in kn)
  Ko.hasOwnProperty(bl) || (Ko[bl] = kn[bl]);
function qy(n) {
  var e = Uy && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || Ky && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? Ko : kn)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const Jy = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function Gy(n) {
...
function Xy(n) {
  return new Ae({ props: { handleKeyDown: Qy(n) } });
}
function Qy(n) {
  let e = Yy(n);
  return function(t, r) {
    let i = qy(r), o, s = e[wl(i, r)];
    ...
    if (i.length == 1 && i != " ") {
      ...
      if ((r.shiftKey || r.altKey || r.metaKey || i.charCodeAt(0) > 127) && (o = kn[r.keyCode]) && o != i) {
        let l = e[wl(o, r)];
        if (l && l(t.state, t.dispatch, t))
          return !0;
      }
...
const Zy = (n, e) => n.selection.empty ? !1 : (e && e(n.tr.deleteSelection().scrollIntoView()), !0);
function Jd(n, e) {
...
const e0 = (n, e, t) => {
  ...
  if (r.parent.content.size == 0 && (Mr(o, "end") || z.isSelectable(o)))
    for (let s = r.depth; ; s--) {
      let l = Rs(n.doc, r.before(s), r.after(s), R.empty);
...
const i0 = (n, e, t) => {
  ...
  if (r.parent.content.size == 0 && (Mr(o, "start") || z.isSelectable(o))) {
    let s = Rs(n.doc, r.before(), r.after(), R.empty);
...
const s0 = (n, e) => {
  ...
  if (r) {
    if (t.node.isTextblock || !Zn(n.doc, t.from))
      return !1;
    i = t.from;
  } else if (i = Is(n.doc, t.from, -1), i == null)
    return !1;
  if (e) {
    let o = n.tr.join(i);
  ...
  if (t instanceof z) {
    if (t.node.isTextblock || !Zn(n.doc, t.to))
      return !1;
    r = t.to;
  } else if (r = Is(n.doc, t.to, 1), r == null)
    return !1;
...
function p0(n, e, t) {
  ...
  return !r || !i || !r.type.compatibleContent(i.type) ? !1 : !r.content.size && e.parent.canReplace(o - 1, o) ? (t && t(n.tr.delete(e.pos - r.nodeSize, e.pos).scrollIntoView()), !0) : !e.parent.canReplace(o, o + 1) || !(i.isTextblock || Zn(n.doc, e.pos)) ? !1 : (t && t(n.tr.join(e.pos).scrollIntoView()), !0);
}
function Qd(n, e, t, r) {
...
const m0 = Zd(-1), g0 = Zd(1);
function y0(n, e = null) {
  return function(t, r) {
...
function v0(n, e = null) {
  return function(t, r) {
    let { $from: i, $to: o } = t.selection, s = i.blockRange(o);
    if (!s)
      return !1;
    let l = r ? t.tr : null;
    return b0(l, s, n, e) ? (r && r(l.scrollIntoView()), !0) : !1;
  };
}
function b0(n, e, t, r = null) {
...
function w0(n, e, t, r, i) {
  ...
  for (let u = e.startIndex, f = e.endIndex, d = !0; u < f; u++, d = !1)
    !d && br(n.doc, a, l) && (n.split(a, l), a += 2 * l), a += c.child(u).nodeSize;
  return n;
}
function x0(n) {
  return function(e, t) {
    let { $from: r, $to: i } = e.selection, o = r.blockRange(i, (s) => s.childCount > 0 && s.firstChild.type == n);
    return o ? t ? r.node(o.depth - 1).type == n ? k0(e, t, n, o) : S0(e, t, o) : !0 : !1;
  };
}
function k0(n, e, t, r) {
  ...
  return Zn(i.doc, a.pos) && a.nodeBefore.type == a.nodeAfter.type && i.join(a.pos), e(i.scrollIntoView()), !0;
}
function S0(n, e, t) {
...
function eh(n) {
  const e = [], { nodeExtensions: t, markExtensions: r } = zs(n), i = [...t, ...r], o = {
    default: null,
    rendered: !0,
    renderHTML: null,
    parseHTML: null,
  ...
  return "style" in n ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(t) : O0(t.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function Nu(n) {
  return Object.fromEntries(
    Object.entries(n).filter(([e, t]) => e === "attrs" && T0(t) ? !1 : t != null)
  );
}
function M0(n, e) {
  var t;
  const r = eh(n), { nodeExtensions: i, markExtensions: o } = zs(n), s = (t = i.find((c) => B(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
    const u = r.filter((v) => v.type === c.name), f = {
      ...
      const E = B(w, "extendNodeSchema", f);
      return {
        ...v,
        ...E ? E(c) : {}
      };
      ...
      ...d,
      content: ee(B(c, "content", f)),
      marks: ee(B(c, "marks", f)),
      group: ee(B(c, "group", f)),
      inline: ee(B(c, "inline", f)),
      atom: ee(B(c, "atom", f)),
      selectable: ee(B(c, "selectable", f)),
      draggable: ee(B(c, "draggable", f)),
      code: ee(B(c, "code", f)),
      whitespace: ee(B(c, "whitespace", f)),
      linebreakReplacement: ee(B(c, "linebreakReplacement", f)),
      defining: ee(B(c, "defining", f)),
      isolating: ee(B(c, "isolating", f)),
      attrs: Object.fromEntries(u.map((v) => {
        var w;
        return [v.name, { default: (w = v == null ? void 0 : v.attribute) === null || w === void 0 ? void 0 : w.default }];
      }))
    }), p = ee(B(c, "parseHTML", f));
    p && (h.parseDOM = p.map((v) => Du(v, u)));
    const m = B(c, "renderHTML", f);
    m && (h.toDOM = (v) => m({
      node: v,
      HTMLAttributes: oa(v, u)
    }));
    const g = B(c, "renderText", f);
    ...
    const u = r.filter((g) => g.type === c.name), f = {
      ...
      const w = B(v, "extendMarkSchema", f);
      return {
        ...g,
        ...w ? w(c) : {}
      };
      ...
      ...d,
      inclusive: ee(B(c, "inclusive", f)),
      excludes: ee(B(c, "excludes", f)),
      group: ee(B(c, "group", f)),
      spanning: ee(B(c, "spanning", f)),
      code: ee(B(c, "code", f)),
...
function so(n) {
  ...
  return s.forEach((d) => {
    ...
    if (!h)
      return;
    const p = a.state.tr, m = Fs({
      state: a.state,
      transaction: p
    }), g = {
      from: r - (h[0].length - o.length),
      to: i
    }, { commands: v, chain: w, can: E } = new $s({
      editor: t,
      state: m
    });
    d.handler({
  ...
  const { editor: e, rules: t } = n, r = new Ae({
    state: {
      ...
      apply(i, o, s) {
        ...
        return !!a && setTimeout(() => {
          let { text: u } = a;
          typeof u == "string" ? u = u : u = qa(C.from(u), s.schema);
...
function lo(n) {
  return R0(n) !== "Object" ? !1 : n.constructor === Object && Object.getPrototypeOf(n) === Object.prototype;
}
function Hs(n, e) {
  const t = { ...n };
  return lo(n) && lo(e) && Object.keys(e).forEach((r) => {
    lo(e[r]) && lo(n[r]) ? t[r] = Hs(n[r], e[r]) : t[r] = e[r];
  }), t;
}
class Yn {
  constructor(e = {}) {
    this.type = "mark", this.name = "mark", this.parent = null, this.child = null, this.config = {
      ...
      ...this.config,
      ...e
    }, this.name = this.config.name, e.defaultOptions && Object.keys(e.defaultOptions).length > 0 && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${this.name}".`), this.options = this.config.defaultOptions, this.config.addOptions && (this.options = ee(B(this, "addOptions", {
      name: this.name
    }))), this.storage = ee(B(this, "addStorage", {
      name: this.name,
  ...
  configure(e = {}) {
    const t = this.extend({
      ...this.config,
      addOptions: () => Hs(this.options, e)
    });
    return t.name = this.name, t.parent = this.parent, t;
  }
  extend(e = {}) {
    const t = new Yn(e);
    return t.parent = this, this.child = t, t.name = e.name ? e.name : t.parent.name, e.defaultOptions && Object.keys(e.defaultOptions).length > 0 && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${t.name}".`), t.options = ee(B(t, "addOptions", {
      name: t.name
    })), t.storage = ee(B(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
...
function _0(n) {
  const { editor: e, state: t, from: r, to: i, rule: o, pasteEvent: s, dropEvent: l } = n, { commands: a, chain: c, can: u } = new $s({
    editor: e,
    state: t
  }), f = [];
...
function $0(n) {
  ...
  return t.map((u) => new Ae({
    ...
    appendTransaction: (f, d, h) => {
      ...
      if (w) {
        let { text: T } = v;
        typeof T == "string" ? T = T : T = qa(C.from(T), h.schema);
        const { from: b } = v, A = b + T.length, _ = F0(T);
        return a({
          rule: u,
          state: h,
          from: b,
...
class yr {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = yr.resolve(e), this.schema = M0(this.extensions, t), this.setupExtensions();
  }
  static resolve(e) {
    const t = yr.sort(yr.flatten(e)), r = z0(t.map((i) => i.name));
  ...
  static sort(e) {
    return e.sort((r, i) => {
      const o = B(r, "priority") || 100, s = B(i, "priority") || 100;
  ...
  get plugins() {
    const { editor: e } = this, t = yr.sort([...this.extensions].reverse()), r = [], i = [], o = t.map((s) => {
      const l = {
        name: s.name,
        options: s.options,
        storage: s.storage,
      ...
      }, a = [], c = B(s, "addKeyboardShortcuts", l);
      let u = {};
      if (s.type === "mark" && B(s, "exitable", l) && (u.ArrowRight = () => Yn.handleExit({ editor: e, mark: s })), c) {
        const m = Object.fromEntries(Object.entries(c()).map(([g, v]) => [g, () => v({ editor: e })]));
        u = { ...u, ...m };
      }
      const f = Xy(u);
      a.push(f);
      const d = B(s, "addInputRules", l);
      Iu(s, e.options.enableInputRules) && d && r.push(...d());
      const h = B(s, "addPasteRules", l);
      Iu(s, e.options.enablePasteRules) && h && i.push(...h());
      const p = B(s, "addProseMirrorPlugins", l);
      if (p) {
        const m = p();
        a.push(...m);
      }
  ...
  setupExtensions() {
    this.extensions.forEach((e) => {
      ...
      e.type === "mark" && ((t = ee(B(e, "keepOnSplit", r))) !== null && t !== void 0 ? t : !0) && this.splittableMarks.push(e.name);
      const i = B(e, "onBeforeCreate", r), o = B(e, "onCreate", r), s = B(e, "onUpdate", r), l = B(e, "onSelectionUpdate", r), a = B(e, "onTransaction", r), c = B(e, "onFocus", r), u = B(e, "onBlur", r), f = B(e, "onDestroy", r);
...
const H0 = $e.create({
      ...
      new Ae({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: n } = this, { state: e, schema: t } = n, { doc: r, selection: i } = e, { ranges: o } = i, s = Math.min(...o.map((u) => u.$from.pos)), l = Math.max(...o.map((u) => u.$to.pos)), a = Ga(t);
...
}), V0 = () => ({ editor: n, view: e }) => (requestAnimationFrame(() => {
  var t;
  n.isDestroyed || (e.dom.blur(), (t = window == null ? void 0 : window.getSelection()) === null || t === void 0 || t.removeAllRanges());
}), !0), j0 = (n = !1) => ({ commands: e }) => e.setContent("", n), W0 = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, U0 = (n) => (e) => n(e), K0 = () => ({ state: n, dispatch: e }) => f0(n, e), q0 = (n, e) => ({ editor: t, tr: r }) => {
  ...
  return !1;
}, G0 = (n) => ({ tr: e, state: t, dispatch: r }) => {
  const i = ke(n, t.schema), o = e.selection.$anchor;
  ...
  return !1;
}, Y0 = (n) => ({ tr: e, dispatch: t }) => {
  const { from: r, to: i } = n;
  return t && e.delete(r, i), !0;
}, X0 = () => ({ state: n, dispatch: e }) => Zy(n, e), Q0 = () => ({ commands: n }) => n.keyboardShortcut("Enter"), Z0 = () => ({ state: n, dispatch: e }) => u0(n, e);
function qo(n, e, t = { strict: !0 }) {
  const r = Object.keys(e);
  return r.length ? r.every((i) => t.strict ? e[i] === n[i] : Ja(e[i]) ? e[i].test(n[i]) : e[i] === n[i]) : !0;
}
function rh(n, e, t = {}) {
...
function ih(n, e = null) {
  ...
  return e === "all" ? X.create(n, Kt(0, i, o), Kt(n.content.size, i, o)) : X.create(n, Kt(e, i, o), Kt(e, i, o));
}
function nv() {
...
const rv = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  const s = () => {
    (Qa() || nv()) && r.dom.focus(), requestAnimationFrame(() => {
      t.isDestroyed || (r.focus(), e != null && e.scrollIntoView && t.commands.scrollIntoView());
    });
  };
  if (r.hasFocus() && n === null || n === !1)
    return !0;
  if (o && n === null && !Xa(t.state.selection))
    return s(), !0;
...
}, iv = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), ov = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), oh = (n) => {
...
function Jo(n, e, t) {
  if (n instanceof xt || n instanceof C)
    return n;
  t = {
    slice: !0,
    parseOptions: {},
...
const lv = (n) => !("type" in n), av = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  var s;
  if (i) {
    t = {
    ...
    t.updateSelection && sv(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: a, text: h }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: a, text: h });
  }
  return !0;
}, cv = () => ({ state: n, dispatch: e }) => s0(n, e), uv = () => ({ state: n, dispatch: e }) => l0(n, e), fv = () => ({ state: n, dispatch: e }) => e0(n, e), dv = () => ({ state: n, dispatch: e }) => i0(n, e), hv = () => ({ state: n, dispatch: e, tr: t }) => {
  try {
    const r = Is(n.doc, n.selection.$from.pos, -1);
...
}, mv = () => ({ state: n, dispatch: e }) => t0(n, e), gv = () => ({ state: n, dispatch: e }) => n0(n, e);
function sh() {
...
const vv = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = yv(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
function Ti(n, e, t = {}) {
  const { from: r, to: i, empty: o } = n.selection, s = e ? ke(e, n.schema) : null, l = [];
...
const bv = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = ke(n, t.schema);
  return Ti(t, i, e) ? a0(t, r) : !1;
}, wv = () => ({ state: n, dispatch: e }) => d0(n, e), xv = (n) => ({ state: e, dispatch: t }) => {
  const r = ke(n, e.schema);
  return x0(r)(e, t);
}, kv = () => ({ state: n, dispatch: e }) => c0(n, e);
function Vs(n, e) {
...
const Sv = (n, e) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = Vs(typeof n == "string" ? n : n.name, r.schema);
  return l ? (l === "node" && (o = ke(n, r.schema)), l === "mark" && (s = En(n, r.schema)), i && t.selection.ranges.forEach((a) => {
...
}, Ev = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), Cv = () => ({ tr: n, dispatch: e }) => {
  if (e) {
    const t = new ft(n.doc);
    n.setSelection(t);
  }
  return !0;
}, Tv = () => ({ state: n, dispatch: e }) => r0(n, e), Ov = () => ({ state: n, dispatch: e }) => o0(n, e), Mv = () => ({ state: n, dispatch: e }) => h0(n, e), Av = () => ({ state: n, dispatch: e }) => g0(n, e), Dv = () => ({ state: n, dispatch: e }) => m0(n, e);
function sa(n, e, t = {}, r = {}) {
  return Jo(n, e, {
    slice: !1,
    parseOptions: t,
...
const Nv = (n, e = !1, t = {}, r = {}) => ({ editor: i, tr: o, dispatch: s, commands: l }) => {
  var a, c;
  const { doc: u } = o;
  if (t.preserveWhitespace !== "full") {
    const f = sa(n, i.schema, t, {
...
function Bv(n, e) {
  const t = ke(e, n.schema), { from: r, to: i } = n.selection, o = [];
...
function ch(n, e) {
  ...
  return t === "node" ? Bv(n, e) : t === "mark" ? lh(n, e) : {};
}
...
function ec(n, e, t) {
  ...
  return n === e ? t.resolve(n).marks().forEach((i) => {
    const o = t.resolve(n), s = Ya(o, i.type);
    !s || r.push({
      mark: i,
      ...s
    });
...
function zv(n, e, t = {}) {
  if (!e)
    return Ti(n, null, t) || la(n, null, t);
  const r = Vs(e, n.schema);
  return r === "node" ? Ti(n, e, t) : r === "mark" ? la(n, e, t) : !1;
}
function Lu(n, e) {
...
function js(n, { checkChildren: e = !0, ignoreWhitespace: t = !1 } = {}) {
  var r;
  if (t) {
  ...
  if (e) {
    ...
    return n.content.forEach((o) => {
      i !== !1 && (js(o, { ignoreWhitespace: t, checkChildren: e }) || (i = !1));
    }), i;
  }
  return !1;
}
...
function uh(n, e, t) {
  const i = n.state.doc.content.size, o = Kt(e, 0, i), s = Kt(t, 0, i), l = n.coordsAtPos(o), a = n.coordsAtPos(s, -1), c = Math.min(l.top, a.top), u = Math.max(l.bottom, a.bottom), f = Math.min(l.left, a.left), d = Math.max(l.right, a.right), h = d - f, p = u - c, v = {
    top: c,
    bottom: u,
    left: f,
    right: d,
...
const jv = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return Vv(r, t, a);
}, Wv = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), Uv = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
  const o = ke(n, t.schema);
  let s;
  ...
  if (t) {
    const { doc: r } = e, i = Kt(n, 0, r.content.size), o = z.create(r, i);
    e.setSelection(o);
  }
  return !0;
}, qv = (n) => ({ tr: e, dispatch: t }) => {
  if (t) {
    const { doc: r } = e, { from: i, to: o } = typeof n == "number" ? { from: n, to: n } : n, s = X.atStart(r).from, l = X.atEnd(r).to, a = Kt(i, s, l), c = Kt(o, s, l), u = X.create(r, a, c);
    e.setSelection(u);
  }
  return !0;
...
const Gv = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (o instanceof z && o.node.isBlock)
    return !l.parentOffset || !br(s, l.pos) ? !1 : (r && (n && Bu(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  const f = a.parentOffset === a.parent.content.size, d = l.depth === 0 ? void 0 : Rv(l.node(-1).contentMatchAt(l.indexAfter(-1)));
  let h = f && d ? [
    {
      type: d,
      attrs: u
    }
  ] : void 0, p = br(e.doc, e.mapping.map(l.pos), 1, h);
  if (!h && !p && br(e.doc, e.mapping.map(l.pos), 1, d ? [{ type: d }] : void 0) && (p = !0, h = d ? [
    {
      type: d,
      attrs: u
    }
  ...
  return p;
}, Yv = (n, e = {}) => ({ tr: t, state: r, dispatch: i, editor: o }) => {
  var s;
  const l = ke(n, r.schema), { $from: a, $to: c } = r.selection, u = r.selection.node;
  ...
  if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
    ...
    if (i) {
      ...
      for (let _ = a.depth - w; _ >= a.depth - 3; _ -= 1)
        v = C.from(a.node(_).copy(v));
      ...
      let A = -1;
      t.doc.nodesBetween(b, t.doc.content.size, (_, D) => {
        if (A > -1)
          return !1;
        _.isTextblock && _.content.size === 0 && (A = D + 1);
      }), A > -1 && t.setSelection(X.near(t.doc.resolve(A))), t.scrollIntoView();
    }
    return !0;
  }
  ...
  const t = Za((s) => s.type === e)(n.selection);
  if (!t)
    return !0;
  ...
  return t.node.type === (i == null ? void 0 : i.type) && Zn(n.doc, t.pos) && n.join(t.pos), !0;
}, Sl = (n, e) => {
  const t = Za((s) => s.type === e)(n.selection);
  if (!t)
    return !0;
  ...
  if (r === void 0)
    return !0;
  const i = n.doc.nodeAt(r);
  return t.node.type === (i == null ? void 0 : i.type) && Zn(n.doc, r) && n.join(r), !0;
}, Xv = (n, e, t, r = {}) => ({ editor: i, tr: o, state: s, dispatch: l, chain: a, commands: c, can: u }) => {
  const { extensions: f, splittableMarks: d } = i.extensionManager, h = ke(n, s.schema), p = ke(e, s.schema), { selection: m, storedMarks: g } = s, { $from: v, $to: w } = m, E = v.blockRange(w), y = g || m.$to.parentOffset && m.$from.marks();
  if (!E)
    return !1;
  const T = Za((b) => Lu(b.type.name, f))(m);
  if (E.depth >= 1 && T && E.depth - T.depth <= 1) {
    if (T.node.type === h)
      return c.liftListItem(p);
    if (Lu(T.node.type.name, f) && h.validContent(T.node.content) && l)
      return a().command(() => (o.setNodeMarkup(T.pos, h), !0)).command(() => kl(o, h)).command(() => Sl(o, h)).run();
  }
  return !t || !y || !l ? a().command(() => u().wrapInList(h, r) ? !0 : c.clearNodes()).wrapInList(h, r).command(() => kl(o, h)).command(() => Sl(o, h)).run() : a().command(() => {
    const b = u().wrapInList(h, r), A = y.filter((_) => d.includes(_.type.name));
    return o.ensureMarks(A), b ? !0 : c.clearNodes();
  }).wrapInList(h, r).command(() => kl(o, h)).command(() => Sl(o, h)).run();
}, Qv = (n, e = {}, t = {}) => ({ state: r, commands: i }) => {
  const { extendEmptyMarkRange: o = !1 } = t, s = En(n, r.schema);
  return la(r, s, e) ? i.unsetMark(s, { extendEmptyMarkRange: o }) : i.setMark(s, e);
}, Zv = (n, e, t = {}) => ({ state: r, commands: i }) => {
  const o = ke(n, r.schema), s = ke(e, r.schema), l = Ti(r, o, t);
  let a;
  return r.selection.$anchor.sameParent(r.selection.$head) && (a = r.selection.$anchor.parent.attrs), l ? i.setNode(s, a) : i.setNode(o, { ...a, ...t });
}, eb = (n, e = {}) => ({ state: t, commands: r }) => {
  const i = ke(n, t.schema);
...
}, rb = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  var o;
  ...
  if (u && s) {
    let { from: d, to: h } = l;
    const p = (o = c.marks().find((g) => g.type === a)) === null || o === void 0 ? void 0 : o.attrs, m = Ya(c, a, p);
...
}, ib = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = Vs(typeof n == "string" ? n : n.name, r.schema);
  return l ? (l === "node" && (o = ke(n, r.schema)), l === "mark" && (s = En(n, r.schema)), i && t.selection.ranges.forEach((a) => {
...
var lb = /* @__PURE__ */ Object.freeze({
  ...
  clearNodes: W0,
  command: U0,
  createParagraphNear: K0,
  cut: q0,
  deleteCurrentNode: J0,
  deleteNode: G0,
  deleteRange: Y0,
  deleteSelection: X0,
  enter: Q0,
  ...
  joinItemBackward: hv,
  joinItemForward: pv,
  joinTextblockBackward: mv,
  joinTextblockForward: gv,
  joinUp: cv,
  keyboardShortcut: vv,
  lift: bv,
  liftEmptyBlock: wv,
  ...
  scrollIntoView: Ev,
  selectAll: Cv,
  selectNodeBackward: Tv,
  selectNodeForward: Ov,
  selectParentNode: Mv,
  selectTextblockEnd: Av,
  selectTextblockStart: Dv,
  setContent: Nv,
  setMark: jv,
  setMeta: Wv,
  setNode: Uv,
...
}), fb = new He("focusEvents"), db = $e.create({
  name: "focusEvents",
  addProseMirrorPlugins() {
    const { editor: n } = this;
    return [
...
class vb extends C0 {
  ...
  injectCSS() {
    this.options.injectCSS && document && (this.css = yb(gb, this.options.injectNonce));
  }
  setOptions(e = {}) {
    this.options = {
      ...this.options,
  ...
  createExtensionManager() {
    ...
    this.extensionManager = new yr(i, this);
  }
  createCommandManager() {
    this.commandManager = new $s({
      editor: this
    });
  }
  createSchema() {
  ...
  createView() {
    ...
    let t;
    try {
      t = sa(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: this.options.enableContentCheck });
    } catch (s) {
      ...
      }), t = sa(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: !1 });
    }
    const r = ih(t, this.options.autofocus);
    this.view = new Vy(this.options.element, {
  ...
  isActive(e, t) {
    ...
    return zv(this.state, r, i);
  }
  getJSON() {
    return this.state.doc.toJSON();
  }
  getHTML() {
    return qa(this.state.doc.content, this.schema);
  }
  getText(e) {
  ...
  return new D0({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      ...
      if (s) {
        ...
        if (ec(t.from, t.to, e.doc).filter((h) => h.mark.type.excluded.find((m) => m === n.type && m !== h.mark.type)).filter((h) => h.to > c).length)
          return null;
  ...
  return new L0({
    ...
    handler: ({ state: e, range: t, match: r, pasteEvent: i }) => {
      ...
      if (l) {
        ...
        if (ec(t.from, t.to, e.doc).filter((p) => p.mark.type.excluded.find((g) => g === n.type && g !== p.mark.type)).filter((p) => p.to > f).length)
          return null;
...
const bb = Dr.create({
  ...
  name: "text",
  group: "inline"
}), kb = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, Sb = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, Eb = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, Cb = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Tb = Yn.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), Ob = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, Mb = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, Ab = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, Db = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, Nb = Yn.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
...
var Yo = 200, xe = function() {
};
xe.prototype.append = function(e) {
  return e.length ? (e = xe.from(e), !this.length && e || e.length < Yo && this.leafAppend(e) || this.length < Yo && e.leafPrepend(this) || this.appendInner(e)) : this;
};
...
xe.prototype.slice = function(e, t) {
  return e === void 0 && (e = 0), t === void 0 && (t = this.length), e >= t ? xe.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t));
};
xe.prototype.get = function(e) {
  if (!(e < 0 || e >= this.length))
    return this.getInner(e);
};
xe.prototype.forEach = function(e, t, r) {
  t === void 0 && (t = 0), r === void 0 && (r = this.length), t <= r ? this.forEachInner(e, t, r, 0) : this.forEachInvertedInner(e, t, r, 0);
};
xe.prototype.map = function(e, t, r) {
...
xe.from = function(e) {
  return e instanceof xe ? e : e && e.length ? new fh(e) : xe.empty;
};
...
class bt {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > Lb && (l = Pb(l, c), s -= c), new bt(l.append(o), s);
  }
  remapping(e, t) {
    let r = new xi();
  ...
  rebased(e, t) {
    ...
    return f.emptyItemCount() > Rb && (f = f.compress(this.items.length - r.length)), f;
  }
  emptyItemCount() {
    let e = 0;
  ...
  compress(e = this.items.length) {
    ...
    return this.items.forEach((s, l) => {
      if (l >= e)
        ...
        s.map && r--;
    }, this.items.length, 0), new bt(xe.from(i.reverse()), o);
  }
}
bt.empty = new bt(xe.empty, 0);
function Pb(n, e) {
  let t;
...
function Bb(n, e, t, r) {
  ...
  t.getMeta($b) && (n = new ln(n.done, n.undone, null, 0, -1));
  let s = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (s && s.getMeta(Wn))
    return s.getMeta(Wn).redo ? new ln(n.done.addTransform(t, void 0, r, Co(e)), n.undone, _u(t.mapping.maps), n.prevTime, n.prevComposition) : new ln(n.done, n.undone.addTransform(t, void 0, r, Co(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !_b(t, n.prevRanges)), c = s ? El(n.prevRanges, t.mapping) : _u(t.mapping.maps);
    return new ln(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, Co(e)), bt.empty, c, t.time, l == null ? n.prevComposition : l);
  } else
    return (o = t.getMeta("rebased")) ? new ln(n.done.rebased(t, o), n.undone.rebased(t, o), El(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new ln(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), El(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function _b(n, e) {
  if (!e)
    return !1;
...
const Wn = new He("history"), $b = new He("closeHistory");
function zb(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    state: {
      init() {
        return new ln(bt.empty, bt.empty, null, 0, -1);
      },
      apply(e, t, r) {
        return Bb(t, r, e, n);
      }
...
const hh = dh(!1, !0), ph = dh(!0, !0), Hb = $e.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
        ...
        props: {
          decorations: ({ doc: n, selection: e }) => {
            ...
            return n.descendants((s, l) => {
              const a = r >= l && r <= l + s.nodeSize, c = !s.isLeaf && js(s);
...
}), jb = "\xF6", Wb = "\u03B5\u03BB1\u03C52\u0431\u04331\u0435\u043B3\u0434\u0435\u0442\u04384\u0435\u044E2\u043A\u0430\u0442\u043E\u043B\u0438\u043A6\u043E\u043C3\u043C\u043A\u04342\u043E\u043D1\u0441\u043A\u0432\u04306\u043E\u043D\u043B\u0430\u0439\u043D5\u0440\u04333\u0440\u0443\u04412\u04442\u0441\u0430\u0439\u04423\u0440\u04313\u0443\u043A\u04403\u049B\u0430\u04373\u0570\u0561\u05753\u05D9\u05E9\u05E8\u05D0\u05DC5\u05E7\u05D5\u05DD3\u0627\u0628\u0648\u0638\u0628\u064A5\u0631\u0627\u0645\u0643\u06485\u0644\u0627\u0631\u062F\u06464\u0628\u062D\u0631\u064A\u06465\u062C\u0632\u0627\u0626\u06315\u0633\u0639\u0648\u062F\u064A\u06296\u0639\u0644\u064A\u0627\u06465\u0645\u063A\u0631\u06285\u0645\u0627\u0631\u0627\u062A5\u06CC\u0631\u0627\u06465\u0628\u0627\u0631\u062A2\u0632\u0627\u06314\u064A\u062A\u06433\u06BE\u0627\u0631\u062A5\u062A\u0648\u0646\u06334\u0633\u0648\u062F\u0627\u06463\u0631\u064A\u06295\u0634\u0628\u0643\u06294\u0639\u0631\u0627\u06422\u06282\u0645\u0627\u06464\u0641\u0644\u0633\u0637\u064A\u06466\u0642\u0637\u06313\u0643\u0627\u062B\u0648\u0644\u064A\u06436\u0648\u06453\u0645\u0635\u06312\u0644\u064A\u0633\u064A\u06275\u0648\u0631\u064A\u062A\u0627\u0646\u064A\u06277\u0642\u06394\u0647\u0645\u0631\u0627\u06475\u067E\u0627\u06A9\u0633\u062A\u0627\u06467\u0680\u0627\u0631\u062A4\u0915\u0949\u092E3\u0928\u0947\u091F3\u092D\u093E\u0930\u09240\u092E\u094D3\u094B\u09245\u0938\u0902\u0917\u0920\u09285\u09AC\u09BE\u0982\u09B2\u09BE5\u09AD\u09BE\u09B0\u09A42\u09F0\u09A44\u0A2D\u0A3E\u0A30\u0A244\u0AAD\u0ABE\u0AB0\u0AA44\u0B2D\u0B3E\u0B30\u0B244\u0B87\u0BA8\u0BCD\u0BA4\u0BBF\u0BAF\u0BBE6\u0BB2\u0B99\u0BCD\u0B95\u0BC86\u0B9A\u0BBF\u0B99\u0BCD\u0B95\u0BAA\u0BCD\u0BAA\u0BC2\u0BB0\u0BCD11\u0C2D\u0C3E\u0C30\u0C24\u0C4D5\u0CAD\u0CBE\u0CB0\u0CA44\u0D2D\u0D3E\u0D30\u0D24\u0D025\u0DBD\u0D82\u0D9A\u0DCF4\u0E04\u0E2D\u0E213\u0E44\u0E17\u0E223\u0EA5\u0EB2\u0EA73\u10D2\u10D42\u307F\u3093\u306A3\u30A2\u30DE\u30BE\u30F34\u30AF\u30E9\u30A6\u30C94\u30B0\u30FC\u30B0\u30EB4\u30B3\u30E02\u30B9\u30C8\u30A23\u30BB\u30FC\u30EB3\u30D5\u30A1\u30C3\u30B7\u30E7\u30F36\u30DD\u30A4\u30F3\u30C84\u4E16\u754C2\u4E2D\u4FE11\u56FD1\u570B1\u6587\u7F513\u4E9A\u9A6C\u900A3\u4F01\u4E1A2\u4F5B\u5C712\u4FE1\u606F2\u5065\u5EB72\u516B\u53662\u516C\u53F81\u76CA2\u53F0\u6E7E1\u70632\u5546\u57CE1\u5E971\u68072\u5609\u91CC0\u5927\u9152\u5E975\u5728\u7EBF2\u5927\u62FF2\u5929\u4E3B\u65593\u5A31\u4E502\u5BB6\u96FB2\u5E7F\u4E1C2\u5FAE\u535A2\u6148\u55842\u6211\u7231\u4F603\u624B\u673A2\u62DB\u80582\u653F\u52A11\u5E9C2\u65B0\u52A0\u57612\u95FB2\u65F6\u5C1A2\u66F8\u7C4D2\u673A\u67842\u6DE1\u9A6C\u95213\u6E38\u620F2\u6FB3\u95802\u70B9\u770B2\u79FB\u52A82\u7EC4\u7EC7\u673A\u67844\u7F51\u57401\u5E971\u7AD91\u7EDC2\u8054\u901A2\u8C37\u6B4C2\u8D2D\u72692\u901A\u8CA92\u96C6\u56E22\u96FB\u8A0A\u76C8\u79D14\u98DE\u5229\u6D663\u98DF\u54C12\u9910\u53852\u9999\u683C\u91CC\u62C93\u6E2F2\uB2F7\uB1371\uCEF42\uC0BC\uC1312\uD55C\uAD6D2", Nr = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, aa = "numeric", ca = "ascii", ua = "alpha", ui = "asciinumeric", ei = "alphanumeric", fa = "domain", mh = "emoji", Ub = "scheme", Kb = "slashscheme", Tl = "whitespace";
function qb(n, e) {
  return n in e || (e[n] = []), e[n];
}
function $n(n, e, t) {
  e[aa] && (e[ui] = !0, e[ei] = !0), e[ca] && (e[ui] = !0, e[ua] = !0), e[ui] && (e[ei] = !0), e[ua] && (e[ei] = !0), e[ei] && (e[fa] = !0), e[mh] && (e[fa] = !0);
  for (const r in e) {
    const i = qb(r, t);
...
const J = (n, e, t, r, i) => n.ta(e, t, r, i), ue = (n, e, t, r, i) => n.tr(e, t, r, i), $u = (n, e, t, r, i) => n.ts(e, t, r, i), O = (n, e, t, r, i) => n.tt(e, t, r, i), Vt = "WORD", da = "UWORD", gh = "ASCIINUMERICAL", yh = "ALPHANUMERICAL", Mi = "LOCALHOST", ha = "TLD", pa = "UTLD", To = "SCHEME", hr = "SLASH_SCHEME", tc = "NUM", ma = "WS", nc = "NL", fi = "OPENBRACE", di = "CLOSEBRACE", Xo = "OPENBRACKET", Qo = "CLOSEBRACKET", Zo = "OPENPAREN", es = "CLOSEPAREN", ts = "OPENANGLEBRACKET", ns = "CLOSEANGLEBRACKET", rs = "FULLWIDTHLEFTPAREN", is = "FULLWIDTHRIGHTPAREN", ss = "LEFTCORNERBRACKET", ls = "RIGHTCORNERBRACKET", as = "LEFTWHITECORNERBRACKET", cs = "RIGHTWHITECORNERBRACKET", us = "FULLWIDTHLESSTHAN", fs = "FULLWIDTHGREATERTHAN", ds = "AMPERSAND", rc = "APOSTROPHE", hs = "ASTERISK", an = "AT", ps = "BACKSLASH", ms = "BACKTICK", gs = "CARET", hn = "COLON", ic = "COMMA", ys = "DOLLAR", Et = "DOT", vs = "EQUALS", oc = "EXCLAMATION", st = "HYPHEN", hi = "PERCENT", bs = "PIPE", ws = "PLUS", xs = "POUND", pi = "QUERY", sc = "QUOTE", vh = "FULLWIDTHMIDDLEDOT", lc = "SEMI", Ct = "SLASH", mi = "TILDE", ks = "UNDERSCORE", bh = "EMOJI", Ss = "SYM";
...
const zt = /[a-z]/, Kr = /\p{L}/u, Ol = /\p{Emoji}/u, Ht = /\d/, Ml = /\s/, zu = "\r", Al = `
`, Gb = "\uFE0F", Yb = "\u200D", Dl = "\uFFFC";
let uo = null, fo = null;
function Xb(n = []) {
  const e = {};
  Ue.groups = e;
  const t = new Ue();
  uo == null && (uo = Hu(jb)), fo == null && (fo = Hu(Wb)), O(t, "'", rc), O(t, "{", fi), O(t, "}", di), O(t, "[", Xo), O(t, "]", Qo), O(t, "(", Zo), O(t, ")", es), O(t, "<", ts), O(t, ">", ns), O(t, "\uFF08", rs), O(t, "\uFF09", is), O(t, "\u300C", ss), O(t, "\u300D", ls), O(t, "\u300E", as), O(t, "\u300F", cs), O(t, "\uFF1C", us), O(t, "\uFF1E", fs), O(t, "&", ds), O(t, "*", hs), O(t, "@", an), O(t, "`", ms), O(t, "^", gs), O(t, ":", hn), O(t, ",", ic), O(t, "$", ys), O(t, ".", Et), O(t, "=", vs), O(t, "!", oc), O(t, "-", st), O(t, "%", hi), O(t, "|", bs), O(t, "+", ws), O(t, "#", xs), O(t, "?", pi), O(t, '"', sc), O(t, "/", Ct), O(t, ";", lc), O(t, "~", mi), O(t, "_", ks), O(t, "\\", ps), O(t, "\u30FB", vh);
  const r = ue(t, Ht, tc, {
    [aa]: !0
  });
  ue(r, Ht, r);
  ...
  O(t, Dl, u), O(c, Al, a), O(c, Dl, u), ue(c, Ml, u), O(u, zu), O(u, Al), ue(u, Ml, u), O(u, Dl, u);
  const f = ue(t, Ol, bh, {
    [mh]: !0
  });
  O(f, "#"), ue(f, Ol, f), O(f, Gb, f);
  const d = O(f, Yb);
  O(d, "#"), ue(d, Ol, f);
  ...
  $n(ha, {
    ...
    utld: !0,
    alpha: !0
  }, e), nn(t, "file", To, Vt, h), nn(t, "mailto", To, Vt, h), nn(t, "http", hr, Vt, h), nn(t, "https", hr, Vt, h), nn(t, "ftp", hr, Vt, h), nn(t, "ftps", hr, Vt, h), $n(To, {
    scheme: !0,
    ascii: !0
  }, e), $n(hr, {
    slashscheme: !0,
  ...
  for (let m = 0; m < n.length; m++) {
    ...
    g.indexOf("-") >= 0 ? w[fa] = !0 : zt.test(g) ? Ht.test(g) ? w[ui] = !0 : w[ca] = !0 : w[aa] = !0, $u(t, g, g, w);
  }
...
function xh(n, e) {
  const t = Qb(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = t.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
function e1({
  ...
  const e = n.domain.concat([ds, hs, an, ps, ms, gs, ys, vs, st, tc, hi, bs, ws, xs, Ct, Ss, mi, ks]), t = [hn, ic, Et, oc, hi, pi, sc, lc, ts, ns, fi, di, Qo, Xo, Zo, es, rs, is, ss, ls, as, cs, us, fs], r = [ds, rc, hs, ps, ms, gs, ys, vs, st, fi, di, hi, bs, ws, xs, pi, Ct, Ss, mi, ks], i = ot(), o = O(i, mi);
  J(o, r, o), J(o, n.domain, o);
  const s = ot(), l = ot(), a = ot();
  J(i, n.domain, s), J(i, n.scheme, l), J(i, n.slashscheme, a), J(s, r, o), J(s, n.domain, s);
  const c = O(s, an);
  O(o, an, c), O(l, an, c), O(a, an, c);
  const u = O(o, Et);
  ...
  const w = ot(ho);
  J(v, n.tld, w), J(v, n.utld, w), J(w, n.domain, s), J(w, r, o), O(w, Et, v), O(w, st, g), O(w, an, c);
  const E = O(w, hn), y = ot(ho);
  J(E, n.numeric, y);
  const T = ot(ho), b = ot();
  J(T, e, T), J(T, t, b), J(b, e, T), J(b, t, b), O(w, Ct, T), O(y, Ct, T);
  const A = O(l, hn), _ = O(a, hn), D = O(_, Ct), $ = O(D, Ct);
  J(l, n.domain, s), O(l, Et, v), O(l, st, g), J(a, n.domain, s), O(a, Et, v), O(a, st, g), J(A, n.domain, T), O(A, Ct, T), O(A, pi, T), J($, n.domain, T), J($, e, T), O($, Ct, T);
  const K = [
    [fi, di],
    [Xo, Qo],
    [Zo, es],
  ...
  for (let U = 0; U < K.length; U++) {
    ...
    J(re, e, x);
    const S = ot();
    J(re, t), J(x, e, x), J(x, t, S), J(S, e, x), J(S, t, S), O(x, Y, T), O(S, Y, T);
  }
  return O(i, Mi, w), O(i, nc, Zb), {
    start: i,
    tokens: wh
  };
}
function t1(n, e, t) {
  ...
  for (; i < r; ) {
    ...
    if (d < 0)
      ...
      s.length > 0 && (o.push(Nl(Wu, e, s)), s = []), i -= d, u -= d;
      const h = f.t, p = t.slice(i - u, i);
      o.push(Nl(h, e, p));
    }
  }
  return s.length > 0 && o.push(Nl(Wu, e, s)), o;
}
function Nl(n, e, t) {
  const r = t[0].s, i = t[t.length - 1].e, o = e.slice(r, i);
  return new n(o, t);
}
const n1 = typeof console < "u" && console && console.warn || (() => {
}), r1 = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ae = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function Uu(n, e = !1) {
  if (ae.initialized && n1(`linkifyjs: already initialized - will not register custom scheme "${n}" ${r1}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function o1() {
  ae.scanner = Xb(ae.customSchemes);
  for (let n = 0; n < ae.tokenQueue.length; n++)
    ae.tokenQueue[n][1]({
      scanner: ae.scanner
    });
  ae.parser = e1(ae.scanner.tokens);
...
function cc(n) {
  return ae.initialized || o1(), t1(ae.parser.start, n, xh(ae.scanner.start, n));
}
cc.scan = xh;
...
function l1(n) {
  return new Ae({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, l = Iv(t.doc, [...e]);
      if ($v(l).forEach(({ newRange: c }) => {
        const u = Pv(r.doc, c, (h) => h.isTextblock);
        let f, d;
        if (u.length > 1 ? (f = u[0], d = r.doc.textBetween(f.pos, f.pos + f.node.nodeSize, void 0, " ")) : u.length && r.doc.textBetween(c.from, c.to, " ", " ").endsWith(" ") && (f = u[0], d = r.doc.textBetween(f.pos, c.to, void 0, " ")), f && d) {
          ...
          g.filter((v) => v.isLink).map((v) => ({
            ...
            ec(v.from, v.to, r.doc).some((w) => w.mark.type === n.type) || s.addMark(v.from, v.to, n.type.create({
              href: v.href
            }));
          });
        }
...
function Nn(n, e) {
  ...
  return e && e.forEach((r) => {
    ...
    i && t.push(i);
  }), !n || n.replace(u1, "").match(new RegExp(
...
const f1 = Yn.create({
  ...
  addProseMirrorPlugins() {
    ...
    return this.options.autolink && n.push(l1({
      type: this.type,
      defaultProtocol: this.options.defaultProtocol,
    ...
    })), this.options.openOnClick === !0 && n.push(a1({
      type: this.type
    })), this.options.linkOnPaste && n.push(c1({
      editor: this.editor,
      defaultProtocol: this.options.defaultProtocol,
      type: this.type
    })), n;
...
var Je = "top", pt = "bottom", mt = "right", Ge = "left", uc = "auto", $i = [Je, pt, mt, Ge], Ir = "start", Di = "end", d1 = "clippingParents", Eh = "viewport", qr = "popper", h1 = "reference", Ku = /* @__PURE__ */ $i.reduce(function(n, e) {
  return n.concat([e + "-" + Ir, e + "-" + Di]);
}, []), Ch = /* @__PURE__ */ [].concat($i, [uc]).reduce(function(n, e) {
  return n.concat([e, e + "-" + Ir, e + "-" + Di]);
}, []), p1 = "beforeRead", m1 = "read", g1 = "afterRead", y1 = "beforeMain", v1 = "main", b1 = "afterMain", w1 = "beforeWrite", x1 = "write", k1 = "afterWrite", S1 = [p1, m1, g1, y1, v1, b1, w1, x1, k1];
function Lt(n) {
...
var Un = Math.max, Es = Math.min, Rr = Math.round;
function ga() {
...
function Pr(n, e, t) {
  ...
  var s = Xn(n) ? rt(n) : window, l = s.visualViewport, a = !Oh() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, u = (r.top + (a && l ? l.offsetTop : 0)) / o, f = r.width / i, d = r.height / o;
  return {
    width: f,
    height: d,
    top: u,
...
function Cn(n) {
  return ((Xn(n) ? n.ownerDocument : n.document) || window.document).documentElement;
}
function Us(n) {
  return Lt(n) === "html" ? n : n.assignedSlot || n.parentNode || (fc(n) ? n.host : null) || Cn(n);
}
function qu(n) {
  return !ht(n) || Yt(n).position === "fixed" ? null : n.offsetParent;
}
function O1(n) {
  var e = /firefox/i.test(ga()), t = /Trident/i.test(ga());
  if (t && ht(n)) {
    var r = Yt(n);
    if (r.position === "fixed")
      return null;
...
function zi(n) {
  for (var e = rt(n), t = qu(n); t && T1(t) && Yt(t).position === "static"; )
    t = qu(t);
  return t && (Lt(t) === "html" || Lt(t) === "body" && Yt(t).position === "static") ? e : t || O1(n) || e;
}
function hc(n) {
...
function D1(n) {
  var e, t = n.state, r = n.name, i = n.options, o = t.elements.arrow, s = t.modifiersData.popperOffsets, l = Nt(t.placement), a = hc(l), c = [Ge, mt].indexOf(l) >= 0, u = c ? "height" : "width";
  if (!(!o || !s)) {
    var f = A1(i.padding, t), d = dc(o), h = a === "y" ? Je : Ge, p = a === "y" ? pt : mt, m = t.rects.reference[u] + t.rects.reference[a] - s[a] - t.rects.popper[u], g = s[a] - t.rects.reference[a], v = zi(o), w = v ? a === "y" ? v.clientHeight || 0 : v.clientWidth || 0 : 0, E = m / 2 - g / 2, y = f[h], T = w - d[u] - f[p], b = w / 2 - d[u] / 2 + E, A = gi(y, b, T), _ = a;
    t.modifiersData[r] = (e = {}, e[_] = A, e.centerOffset = A - b, e);
  }
}
function N1(n) {
...
function Ju(n) {
  ...
  h = g.x, m = g.y;
  var v = s.hasOwnProperty("x"), w = s.hasOwnProperty("y"), E = Ge, y = Je, T = window;
  if (c) {
    var b = zi(t), A = "clientHeight", _ = "clientWidth";
    if (b === rt(t) && (b = Cn(t), Yt(b).position !== "static" && l === "absolute" && (A = "scrollHeight", _ = "scrollWidth")), b = b, i === Je || (i === Ge || i === mt) && o === Di) {
      y = pt;
      var D = f && b === T && T.visualViewport ? T.visualViewport.height : b[A];
      m -= D - r.height, m *= a ? 1 : -1;
    }
    if (i === Ge || (i === Je || i === pt) && o === Di) {
      E = mt;
      var $ = f && b === T && T.visualViewport ? T.visualViewport.width : b[_];
      h -= $ - r.width, h *= a ? 1 : -1;
    }
  }
  var K = Object.assign({
...
function V1(n) {
  ...
  return Yt(i || t).direction === "rtl" && (l += Un(t.clientWidth, i ? i.clientWidth : 0) - o), {
    width: o,
    height: s,
    x: l,
    y: a
...
function gc(n) {
  var e = Yt(n), t = e.overflow, r = e.overflowX, i = e.overflowY;
  return /auto|scroll|overlay|hidden/.test(t + i + r);
}
function Ih(n) {
  return ["html", "body", "#document"].indexOf(Lt(n)) >= 0 ? n.ownerDocument.body : ht(n) && gc(n) ? n : Ih(Us(n));
}
function yi(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = Ih(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = rt(r), s = i ? [o].concat(o.visualViewport || [], gc(r) ? r : []) : r, l = e.concat(s);
  return i ? l : l.concat(yi(Us(s)));
}
function ya(n) {
...
function Yu(n, e, t) {
  return e === Eh ? ya(H1(n, t)) : Xn(e) ? j1(e, t) : ya(V1(Cn(n)));
}
function W1(n) {
  var e = yi(Us(n)), t = ["absolute", "fixed"].indexOf(Yt(n).position) >= 0, r = t && ht(n) ? zi(n) : n;
  return Xn(r) ? e.filter(function(i) {
    return Xn(i) && Mh(i, r) && Lt(i) !== "body";
  }) : [];
}
function U1(n, e, t, r) {
  var i = e === "clippingParents" ? W1(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var u = Yu(n, c, r);
    return a.top = Un(u.top, a.top), a.right = Es(u.right, a.right), a.bottom = Es(u.bottom, a.bottom), a.left = Un(u.left, a.left), a;
  }, Yu(n, s, r));
...
function Ni(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? d1 : l, c = t.rootBoundary, u = c === void 0 ? Eh : c, f = t.elementContext, d = f === void 0 ? qr : f, h = t.altBoundary, p = h === void 0 ? !1 : h, m = t.padding, g = m === void 0 ? 0 : m, v = Dh(typeof g != "number" ? g : Nh(g, $i)), w = d === qr ? h1 : qr, E = n.rects.popper, y = n.elements[p ? w : d], T = U1(Xn(y) ? y : y.contextElement || Cn(n.elements.popper), a, u, s), b = Pr(n.elements.reference), A = Rh({
    reference: b,
    element: E,
    strategy: "absolute",
    placement: i
  }), _ = ya(Object.assign({}, E, A)), D = d === qr ? _ : b, $ = {
    top: T.top - D.top + v.top,
    bottom: D.bottom - T.bottom + v.bottom,
    left: T.left - D.left + v.left,
    right: D.right - T.right + v.right
  }, K = n.modifiersData.offset;
  if (d === qr && K) {
    var U = K[i];
    Object.keys($).forEach(function(G) {
      var Y = [mt, pt].indexOf(G) >= 0 ? 1 : -1, re = [Je, pt].indexOf(G) >= 0 ? "y" : "x";
      $[G] += U[re] * Y;
    });
  }
  return $;
...
function J1(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, u = t.boundary, f = t.rootBoundary, d = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, m = t.allowedAutoPlacements, g = e.options.placement, v = Nt(g), w = v === g, E = a || (w || !p ? [Oo(g)] : q1(g)), y = [g].concat(E).reduce(function(Ve, gt) {
      return Ve.concat(Nt(gt) === uc ? K1(e, {
        placement: gt,
        boundary: u,
        rootBoundary: f,
        padding: c,
    ...
    }, []), T = e.rects.reference, b = e.rects.popper, A = /* @__PURE__ */ new Map(), _ = !0, D = y[0], $ = 0; $ < y.length; $++) {
      var K = y[$], U = Nt(K), G = Lr(K) === Ir, Y = [Je, pt].indexOf(U) >= 0, re = Y ? "width" : "height", x = Ni(e, {
        placement: K,
        boundary: u,
        rootBoundary: f,
        altBoundary: d,
      ...
      T[re] > b[re] && (S = Oo(S));
      var M = Oo(S), I = [];
      if (o && I.push(x[U] <= 0), l && I.push(x[S] <= 0, x[M] <= 0), I.every(function(Ve) {
        return Ve;
      })) {
        D = K, _ = !1;
        break;
    ...
    if (_)
      for (var P = p ? 3 : 1, Q = function(gt) {
        var Bt = y.find(function(er) {
          var _t = A.get(er);
          if (_t)
            return _t.slice(0, gt).every(function(tr) {
              return tr;
            });
        });
        if (Bt)
...
function Qu(n) {
  return [Je, mt, pt, Ge].some(function(e) {
    return n[e] >= 0;
  });
}
function Y1(n) {
...
function Q1(n, e, t) {
  var r = Nt(n), i = [Ge, Je].indexOf(r) >= 0 ? -1 : 1, o = typeof t == "function" ? t(Object.assign({}, e, {
    placement: n
  })) : t, s = o[0], l = o[1];
  return s = s || 0, l = (l || 0) * i, [Ge, mt].indexOf(r) >= 0 ? {
    x: l,
    y: s
  } : {
    x: s,
...
function iw(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, u = t.altBoundary, f = t.padding, d = t.tether, h = d === void 0 ? !0 : d, p = t.tetherOffset, m = p === void 0 ? 0 : p, g = Ni(e, {
    ...
    padding: f,
    altBoundary: u
  }), v = Nt(e.placement), w = Lr(e.placement), E = !w, y = hc(v), T = rw(y), b = e.modifiersData.popperOffsets, A = e.rects.reference, _ = e.rects.popper, D = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, $ = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
    ...
    mainAxis: 0,
    altAxis: 0
  }, D), K = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, U = {
    x: 0,
    y: 0
  };
  if (!!b) {
    if (o) {
      var G, Y = y === "y" ? Je : Ge, re = y === "y" ? pt : mt, x = y === "y" ? "height" : "width", S = b[y], M = S + g[Y], I = S - g[re], P = h ? -_[x] / 2 : 0, Q = w === Ir ? A[x] : _[x], se = w === Ir ? -_[x] : -A[x], Se = e.elements.arrow, Ve = h && Se ? dc(Se) : {
        width: 0,
        height: 0
      }, gt = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Ah(), Bt = gt[Y], er = gt[re], _t = gi(0, A[x], Ve[x]), tr = E ? A[x] / 2 - P - _t - Bt - $.mainAxis : Q - _t - Bt - $.mainAxis, en = E ? -A[x] / 2 + P + _t + er + $.mainAxis : se + _t + er + $.mainAxis, nr = e.elements.arrow && zi(e.elements.arrow), Hi = nr ? y === "y" ? nr.clientTop || 0 : nr.clientLeft || 0 : 0, zr = (G = K == null ? void 0 : K[y]) != null ? G : 0, Vi = S + tr - zr - Hi, ji = S + en - zr, Hr = gi(h ? Es(M, Vi) : M, S, h ? Un(I, ji) : I);
      b[y] = Hr, U[y] = Hr - S;
    }
    if (l) {
      var Vr, Wi = y === "x" ? Je : Ge, Ui = y === "x" ? pt : mt, Ft = b[T], tn = T === "y" ? "height" : "width", jr = Ft + g[Wi], On = Ft - g[Ui], Wr = [Je, Ge].indexOf(v) !== -1, Ki = (Vr = K == null ? void 0 : K[T]) != null ? Vr : 0, qi = Wr ? jr : Ft - A[tn] - _[tn] - Ki + $.altAxis, Ji = Wr ? Ft + A[tn] + _[tn] - Ki - $.altAxis : On, Gi = h && Wr ? M1(qi, Ft, Ji) : gi(h ? qi : jr, Ft, h ? Ji : On);
      b[T] = Gi, U[T] = Gi - Ft;
    }
    e.modifiersData[r] = U;
  }
...
function cw(n, e, t) {
  t === void 0 && (t = !1);
  var r = ht(e), i = ht(e) && aw(e), o = Cn(e), s = Pr(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  return (r || !r && !t) && ((Lt(e) !== "body" || gc(o)) && (l = lw(e)), ht(e) ? (a = Pr(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = mc(o))), {
    ...
    var u = {
      ...
      setOptions: function(v) {
        ...
        m(), u.options = Object.assign({}, o, u.options, w), u.scrollParents = {
          reference: Xn(l) ? yi(l) : l.contextElement ? yi(l.contextElement) : [],
          popper: yi(a)
        };
        var E = fw(hw([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!d) {
          ...
          if (!!ef(w, E)) {
            u.rects = {
              reference: cw(w, zi(E), u.options.strategy === "fixed"),
              popper: dc(E)
            ...
            for (var y = 0; y < u.orderedModifiers.length; y++) {
              ...
              var T = u.orderedModifiers[y], b = T.fn, A = T.options, _ = A === void 0 ? {} : A, D = T.name;
...
var mw = [F1, nw, B1, Th, ew, G1, ow, I1, X1], gw = /* @__PURE__ */ pw({
  defaultModifiers: mw
}), yw = "tippy-box", Ph = "tippy-content", vw = "tippy-backdrop", Lh = "tippy-arrow", Bh = "tippy-svg-arrow", Rn = {
  passive: !0,
  capture: !0
}, _h = function() {
...
function Ow(n) {
  return Ii(n) ? [n] : Ew(n) ? Cs(n) : Array.isArray(n) ? n : Cs(document.querySelectorAll(n));
}
function Rl(n, e) {
...
function Aw(n, e) {
  ...
  return n.every(function(i) {
    var o = i.popperRect, s = i.popperState, l = i.props, a = l.interactiveBorder, c = Sw(s.placement), u = s.modifiersData.offset;
    if (!u)
      return !0;
...
function Iw() {
  document.addEventListener("touchstart", Dw, Rn), window.addEventListener("blur", Nw);
}
var Rw = typeof window < "u" && typeof document < "u", Pw = Rw ? !!window.msCrypto : !1;
function cr(n) {
...
var Ri;
process.env.NODE_ENV !== "production" && Bw();
function Bw() {
  Ri = /* @__PURE__ */ new Set();
}
function Wt(n, e) {
...
function _w(n) {
  ...
  va(e, ["tippy() was passed", "`" + String(n) + "`", "as its targets (first) argument. Valid types are: String, Element,", "Element[], or NodeList."].join(" ")), va(t, ["tippy() was passed a plain object which is not supported as an argument", "for virtual positioning. Use props.getReferenceClientRect instead."].join(" "));
}
var Hh = {
  animateFill: !1,
  followCursor: !1,
  ...
  triggerTarget: null
}, Hh, Fw), $w = Object.keys(nt), zw = function(e) {
...
function cf(n, e) {
  ...
  }, e.ignoreAttributes ? {} : Hw(n, e.plugins));
...
function jh(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = ww(nt, Object.keys(Hh)), o = !bw(i, r);
...
function uf(n) {
  var e = vi();
  return n === !0 ? e.className = Lh : (e.className = Bh, Ii(n) ? e.appendChild(n) : ba(e, n)), e;
}
function ff(n, e) {
  Ii(e.content) ? (ba(n, ""), n.appendChild(e.content)) : typeof e.content != "function" && (e.allowHTML ? ba(n, e.content) : n.textContent = e.content);
}
function wa(n) {
  var e = n.firstElementChild, t = Cs(e.children);
  return {
    box: e,
    ...
    backdrop: t.find(function(r) {
      return r.classList.contains(vw);
    })
  };
}
function Wh(n) {
  var e = vi(), t = vi();
  t.className = yw, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = vi();
  r.className = Ph, r.setAttribute("data-state", "hidden"), ff(r, n.props), e.appendChild(t), t.appendChild(r), i(n.props, n.props);
  function i(o, s) {
    var l = wa(e), a = l.box, c = l.content, u = l.arrow;
...
var jw = 1, mo = [], Ll = [];
function Ww(n, e) {
  var t = cf(n, Object.assign({}, nt, Vh(rf(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, u, f, d, h = [], p = tf(Vi, t.interactiveDebounce), m, g = jw++, v = null, w = kw(t.plugins), E = {
    isEnabled: !0,
    isVisible: !1,
    isDestroyed: !1,
    isMounted: !1,
  ...
  if (!t.render)
    return process.env.NODE_ENV !== "production" && va(!0, "render() function has not been supplied."), y;
  var T = t.render(y), b = T.popper, A = T.onUpdate;
  b.setAttribute("data-tippy-root", ""), b.id = "tippy-" + y.id, y.popper = b, n._tippy = y, b._tippy = y;
  var _ = w.map(function(k) {
    return k.fn(y);
  }), D = n.hasAttribute("aria-expanded");
  return nr(), P(), S(), M("onCreate", [y]), t.showOnCreate && jr(), b.addEventListener("mouseenter", function() {
  ...
  function Y() {
    var k = G().parentNode;
    return k ? Mw(k) : document;
  }
  function re() {
    return wa(b);
  }
  function x(k) {
    return y.state.isMounted && !y.state.isVisible || Ot.isTouch || u && u.type === "focus" ? 0 : Il(y.props.delay, k ? 0 : 1, nt.delay);
  }
  function S(k) {
    k === void 0 && (k = !1), b.style.pointerEvents = y.props.interactive && !k ? "" : "none", b.style.zIndex = "" + y.props.zIndex;
  }
  function M(k, F, j) {
    if (j === void 0 && (j = !0), _.forEach(function(te) {
      te[k] && te[k].apply(te, F);
    }), j) {
      var le;
      (le = y.props)[k].apply(le, F);
    }
  }
  function I() {
    var k = y.props.aria;
    if (!!k.content) {
      var F = "aria-" + k.content, j = b.id, le = pr(y.props.triggerTarget || n);
  ...
  function P() {
    if (!(D || !y.props.aria.expanded)) {
      var k = pr(y.props.triggerTarget || n);
  ...
  function Q() {
    Y().removeEventListener("mousemove", p), mo = mo.filter(function(k) {
      return k !== p;
    });
  }
  function se(k) {
    if (!(Ot.isTouch && (a || k.type === "mousedown"))) {
      ...
      if (!(y.props.interactive && sf(b, F))) {
        if (pr(y.props.triggerTarget || n).some(function(j) {
          return sf(j, F);
        })) {
          if (Ot.isTouch || y.state.isVisible && y.props.trigger.indexOf("click") >= 0)
            return;
        } else
          M("onClickOutside", [y, k]);
  ...
  function gt() {
    var k = Y();
    k.addEventListener("mousedown", se, !0), k.addEventListener("touchend", se, Rn), k.addEventListener("touchstart", Ve, Rn), k.addEventListener("touchmove", Se, Rn);
  }
  function Bt() {
    var k = Y();
    k.removeEventListener("mousedown", se, !0), k.removeEventListener("touchend", se, Rn), k.removeEventListener("touchstart", Ve, Rn), k.removeEventListener("touchmove", Se, Rn);
  }
  function er(k, F) {
    tr(k, function() {
  ...
  function tr(k, F) {
    var j = re().box;
    function le(te) {
      te.target === j && (Pl(j, "remove", le), F());
    }
    if (k === 0)
      return F();
    Pl(j, "remove", f), Pl(j, "add", le), f = le;
  }
  function en(k, F, j) {
    j === void 0 && (j = !1);
    var le = pr(y.props.triggerTarget || n);
    le.forEach(function(te) {
      te.addEventListener(k, F, j), h.push({
        node: te,
        eventType: k,
        handler: F,
        options: j
  ...
  function nr() {
    K() && (en("touchstart", zr, {
      ...
      passive: !0
    })), xw(y.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (en(k, zr), k) {
          case "mouseenter":
            en("mouseleave", ji);
  ...
  function Hi() {
    h.forEach(function(k) {
      var F = k.node, j = k.eventType, le = k.handler, te = k.options;
      F.removeEventListener(j, le, te);
    }), h = [];
  }
  function zr(k) {
    var F, j = !1;
    if (!(!y.state.isEnabled || Vr(k) || l)) {
      var le = ((F = u) == null ? void 0 : F.type) === "focus";
      u = k, m = k.currentTarget, P(), !y.state.isVisible && Cw(k) && mo.forEach(function(te) {
        return te(k);
      }), k.type === "click" && (y.props.trigger.indexOf("mouseenter") < 0 || s) && y.props.hideOnClick !== !1 && y.state.isVisible ? j = !0 : jr(k), k.type === "click" && (s = !j), j && !le && On(k);
    }
  }
  function Vi(k) {
    var F = k.target, j = G().contains(F) || b.contains(F);
    if (!(k.type === "mousemove" && j)) {
      var le = tn().concat(b).map(function(te) {
        var Pe, it = te._tippy, rr = (Pe = it.popperInstance) == null ? void 0 : Pe.state;
        return rr ? {
  ...
  function ji(k) {
    var F = Vr(k) || y.props.trigger.indexOf("click") >= 0 && s;
    if (!F) {
  ...
  function Hr(k) {
    y.props.trigger.indexOf("focusin") < 0 && k.target !== G() || y.props.interactive && k.relatedTarget && b.contains(k.relatedTarget) || On(k);
  }
  function Vr(k) {
    return Ot.isTouch ? K() !== k.type.indexOf("touch") >= 0 : !1;
  }
  function Wi() {
    Ui();
    var k = y.props, F = k.popperOptions, j = k.placement, le = k.offset, te = k.getReferenceClientRect, Pe = k.moveTransition, it = U() ? wa(b).arrow : null, rr = te ? {
      ...
      fn: function(Yi) {
        ...
        if (U()) {
          ...
          ["placement", "reference-hidden", "escaped"].forEach(function(Xi) {
            Xi === "placement" ? qs.setAttribute("data-placement", ir.placement) : ir.attributes.popper["data-popper-" + Xi] ? qs.setAttribute("data-" + Xi, "") : qs.removeAttribute("data-" + Xi);
    ...
    }), Mn.push.apply(Mn, (F == null ? void 0 : F.modifiers) || []), y.popperInstance = gw(rr, b, Object.assign({}, F, {
      placement: j,
      onFirstUpdate: d,
      modifiers: Mn
    }));
  ...
  function Ft() {
    var k = y.props.appendTo, F, j = G();
    y.props.interactive && k === _h || k === "parent" ? F = j.parentNode : F = Fh(k, [j]), F.contains(b) || F.appendChild(b), y.state.isMounted = !0, Wi(), process.env.NODE_ENV !== "production" && Wt(y.props.interactive && k === nt.appendTo && j.nextElementSibling !== b, ["Interactive tippy element may not be accessible via keyboard", "navigation because it is not directly after the reference element", "in the DOM source order.", `
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function tn() {
    return Cs(b.querySelectorAll("[data-tippy-root]"));
  }
  function jr(k) {
    y.clearDelayTimeouts(), k && M("onTrigger", [y, k]), gt();
    var F = x(!0), j = $(), le = j[0], te = j[1];
    Ot.isTouch && le === "hold" && te && (F = te), F ? r = setTimeout(function() {
      y.show();
    }, F) : y.show();
  }
  function On(k) {
    if (y.clearDelayTimeouts(), M("onUntrigger", [y, k]), !y.state.isVisible) {
      Bt();
      return;
    }
  ...
  function Ji(k) {
    if (process.env.NODE_ENV !== "production" && Wt(y.state.isDestroyed, cr("setProps")), !y.state.isDestroyed) {
      M("onBeforeUpdate", [y, k]), Hi();
      var F = y.props, j = cf(n, Object.assign({}, F, rf(k), {
        ignoreAttributes: !0
      }));
      y.props = j, nr(), F.interactiveDebounce !== j.interactiveDebounce && (Q(), p = tf(Vi, j.interactiveDebounce)), F.triggerTarget && !j.triggerTarget ? pr(F.triggerTarget).forEach(function(le) {
        le.removeAttribute("aria-expanded");
      }) : j.triggerTarget && n.removeAttribute("aria-expanded"), P(), S(), A && A(F, j), y.popperInstance && (Wi(), tn().forEach(function(le) {
  ...
  function ip() {
    process.env.NODE_ENV !== "production" && Wt(y.state.isDestroyed, cr("show"));
    var k = y.state.isVisible, F = y.state.isDestroyed, j = !y.state.isEnabled, le = Ot.isTouch && !y.props.touch, te = Il(y.props.duration, 0, nt.duration);
    if (!(k || F || j || le) && !G().hasAttribute("disabled") && (M("onShow", [y], !1), y.props.onShow(y) !== !1)) {
      if (y.state.isVisible = !0, U() && (b.style.visibility = "visible"), S(), gt(), y.state.isMounted || (b.style.transition = "none"), U()) {
        var Pe = re(), it = Pe.box, rr = Pe.content;
        Rl([it, rr], 0);
      }
      d = function() {
        var Mn;
        if (!(!y.state.isVisible || c)) {
          if (c = !0, b.offsetHeight, b.style.transition = y.props.moveTransition, U() && y.props.animation) {
            var Ks = re(), Yi = Ks.box, ir = Ks.content;
            Rl([Yi, ir], te), of([Yi, ir], "visible");
          }
          I(), P(), nf(Ll, y), (Mn = y.popperInstance) == null || Mn.forceUpdate(), M("onMount", [y]), y.props.animation && U() && _t(te, function() {
  ...
  function op() {
    process.env.NODE_ENV !== "production" && Wt(y.state.isDestroyed, cr("hide"));
    var k = !y.state.isVisible, F = y.state.isDestroyed, j = !y.state.isEnabled, le = Il(y.props.duration, 1, nt.duration);
    if (!(k || F || j) && (M("onHide", [y], !1), y.props.onHide(y) !== !1)) {
      if (y.state.isVisible = !1, y.state.isShown = !1, c = !1, s = !1, U() && (b.style.visibility = "hidden"), Q(), Bt(), S(!0), U()) {
        var te = re(), Pe = te.box, it = te.content;
        y.props.animation && (Rl([Pe, it], le), of([Pe, it], "hidden"));
      }
      I(), P(), y.props.animation ? U() && er(le, y.unmount) : y.unmount();
    }
  }
  function sp(k) {
    process.env.NODE_ENV !== "production" && Wt(y.state.isDestroyed, cr("hideWithInteractivity")), Y().addEventListener("mousemove", p), nf(mo, p), p(k);
  }
  function lp() {
    process.env.NODE_ENV !== "production" && Wt(y.state.isDestroyed, cr("unmount")), y.state.isVisible && y.hide(), y.state.isMounted && (Ui(), tn().forEach(function(k) {
      k._tippy.unmount();
    }), b.parentNode && b.parentNode.removeChild(b), Ll = Ll.filter(function(k) {
      return k !== y;
    }), y.state.isMounted = !1, M("onHidden", [y]));
  }
  function ap() {
    process.env.NODE_ENV !== "production" && Wt(y.state.isDestroyed, cr("destroy")), !y.state.isDestroyed && (y.clearDelayTimeouts(), y.unmount(), Hi(), delete n._tippy, y.state.isDestroyed = !0, M("onDestroy", [y]));
  }
}
function Fr(n, e) {
  e === void 0 && (e = {});
  var t = nt.plugins.concat(e.plugins || []);
  process.env.NODE_ENV !== "production" && (_w(n), jh(e, t)), Iw();
...
class Uw {
  constructor({ editor: e, element: t, view: r, tippyOptions: i = {}, updateDelay: o = 250, shouldShow: s }) {
    this.preventHide = !1, this.shouldShow = ({ view: l, state: a, from: c, to: u }) => {
      const { doc: f, selection: d } = a, { empty: h } = d, p = !f.textBetween(c, u).length && Xa(a.selection), m = this.element.contains(document.activeElement);
...
class Kw {
  getTextContent(e) {
    return ah(e, { textSerializers: Ga(this.editor.schema) });
  }
...
function hk(n, e, t, r = "bi-text-left") {
  vc[n] = t, Os.push({
    type: "Turn into",
    icon: r,
    label: e,
...
const Xw = { class: "editor-wrapper" }, Qw = /* @__PURE__ */ ze({
  __name: "Editor",
  props: {
    modelValue: {
      type: String,
  ...
  setup(n, { emit: e }) {
    const t = n, r = e, i = bf({
      ...
      onUpdate: () => {
        var l;
        i.value = Ts(((l = o.value) == null ? void 0 : l.getHTML()) || "");
      }
    }), s = () => {
      if (!o.value)
        return;
    ...
    return wf(() => t.modelValue, (l) => {
      var c, u;
      Ts(((c = o.value) == null ? void 0 : c.getHTML()) || "") !== l && ((u = o.value) == null || u.commands.setContent(hf(l), !1));
    }), (l, a) => (me(), Ke("div", Xw, [
      vt(he(Gw), {
        editor: he(o),
        spellcheck: "false",
        onKeyupCapture: Fl(Mo(() => {
        }, ["prevent"]), ["enter"]),
        onKeydownCapture: Fl(Mo(() => {
        }, ["prevent"]), ["enter"])
...
const Zt = (n, e) => {
  ...
  for (const [r, i] of e)
    t[r] = i;
  return t;
}, qh = /* @__PURE__ */ Zt(Qw, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/elements/Editor.vue"]]), Zw = ["innerHTML"], ex = /* @__PURE__ */ ze({
  __name: "TextBlock",
  props: {
    block: {
      type: Object,
  ...
  setup(n) {
    const e = n;
    return (t, r) => e.readonly ? (me(), Ke("div", {
      key: 1,
...
}), tx = /* @__PURE__ */ Zt(ex, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/blocks/TextBlock.vue"]]), nx = { class: "w-full py-0 h-[1px] bg-neutral-300 mt-[1.2rem]" }, rx = /* @__PURE__ */ ze({
  __name: "DividerBlock",
  props: {
    block: {
      type: Object,
  ...
  setup(n) {
    return (e, t) => (me(), Ke("div", nx));
  }
}), ix = /* @__PURE__ */ Zt(rx, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/blocks/DividerBlock.vue"]]), ox = ["contenteditable", "block-type", "data-ph"], sx = /* @__PURE__ */ ze({
  __name: "HeadingBlock",
  props: {
    block: {
      type: Object,
  ...
  setup(n) {
    ...
    return (i, o) => {
      ...
      }, Ao(t.block.details.value), 43, ox);
    };
  }
}), Bl = /* @__PURE__ */ Zt(sx, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/blocks/HeadingBlock.vue"]]), lx = ["innerHTML"], ax = /* @__PURE__ */ ze({
  __name: "QuoteBlock",
  props: {
    block: {
      type: Object,
...
}), cx = /* @__PURE__ */ Zt(ax, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/blocks/QuoteBlock.vue"]]);
var L;
(function(n) {
...
const vc = {
  ...
  [L.Divider]: ix,
  [L.Quote]: cx
}, Jh = [L.Text, L.Quote], cn = (n) => Jh.some((e) => e === n), Os = [
  {
    type: "Turn into",
    icon: "bi-text-left",
    label: "Text",
...
function hx(n) {
  return n === !0 || n === !1 || px(n) && Xh(n) == "[object Boolean]";
}
function Yh(n) {
...
const mx = "Incorrect 'index' type", gx = (n) => `Invalid value for key ${n}`, yx = (n) => `Pattern length exceeds max of ${n}.`, vx = (n) => `Missing ${n} property in key`, bx = (n) => `Property 'weight' in key '${n}' must be a positive integer`, pf = Object.prototype.hasOwnProperty;
class wx {
  constructor(e) {
  ...
  const i = (o, s, l) => {
    if (!!Qe(o))
      if (!s[l])
        ...
        if (!Qe(c))
          return;
        if (l === s.length - 1 && (At(c) || Gh(c) || hx(c)))
          t.push(dx(c));
        else if (Xt(c)) {
          r = !0;
...
class bc {
  constructor({
    ...
    this.norm = Ox(t, 3), this.getFn = e, this.isCreated = !1, this.setIndexRecords();
  }
  setSources(e = []) {
    this.docs = e;
  }
...
function Mx(n, { getFn: e = W.getFn, fieldNormWeight: t = W.fieldNormWeight } = {}) {
...
function Ax(n = [], e = W.minMatchCharLength) {
  let t = [], r = -1, i = -1, o = 0;
...
function Dx(n, e, t, {
  ...
  for (let A = 0; A < u; A += 1) {
    ...
    for (; _ < D; )
      go(e, {
        ...
        distance: i,
        ignoreLocation: c
      }) <= h ? _ = D : y = D, D = Math.floor((y - _) / 2 + _);
    y = D;
    let $ = Math.max(1, d - D + 1), K = s ? f : Math.min(d + D, f) + u, U = Array(K + 2);
    U[K + 1] = (1 << A) - 1;
    for (let Y = K; Y >= $; Y -= 1) {
      let re = Y - 1, x = t[n.charAt(re)];
      if (m && (g[re] = +!!x), U[Y] = (U[Y + 1] << 1 | 1) & x, A && (U[Y] |= (w[Y + 1] | w[Y]) << 1 | 1 | w[Y + 1]), U[Y] & T && (E = go(e, {
        errors: A,
        currentLocation: re,
        expectedLocation: d,
        distance: i,
  ...
  if (m) {
    const A = Ax(g, l);
    A.length ? a && (b.indices = A) : b.isMatch = !1;
  }
  return b;
}
function Nx(n) {
...
class ep {
  ...
  searchIn(e) {
    ...
    this.chunks.forEach(({ pattern: p, alphabet: m, startIndex: g }) => {
      const { isMatch: v, score: w, indices: E } = Dx(e, p, m, {
        location: i + g,
        distance: o,
        threshold: s,
        findAllMatches: l,
...
function zx(n, e = {}) {
  return n.split($x).map((t) => {
    let r = t.trim().split(Fx).filter((o) => o && !!o.trim()), i = [];
...
const Hx = /* @__PURE__ */ new Set([tp.type, np.type]);
class Vx {
  constructor(e, {
    ...
    this.query = null, this.options = {
      ...
      threshold: a,
      distance: c
    }, this.pattern = t ? e : e.toLowerCase(), this.query = zx(this.pattern, this.options);
  }
...
function Ea(n, e) {
  for (let t = 0, r = Sa.length; t < r; t += 1) {
    let i = Sa[t];
    if (i.condition(n, e))
      return new i(n, e);
  }
...
const Ms = {
  ...
  PATH: "$path",
  PATTERN: "$val"
}, Ta = (n) => !!(n[Ms.AND] || n[Ms.OR]), Wx = (n) => !!n[Ca.PATH], Ux = (n) => !Xt(n) && Yh(n) && !Ta(n), vf = (n) => ({
  [Ms.AND]: Object.keys(n).map((e) => ({
    [e]: n[e]
  }))
});
function rp(n, e, { auto: t = !0 } = {}) {
  const r = (i) => {
    let o = Object.keys(i);
    const s = Wx(i);
    if (!s && o.length > 1 && !Ta(i))
      return r(vf(i));
    if (Ux(i)) {
      const a = s ? i[Ca.PATH] : o[0], c = s ? i[Ca.PATTERN] : i[a];
      if (!At(c))
        throw new Error(gx(a));
      const u = {
        keyId: xa(a),
        pattern: c
      };
      return t && (u.searcher = Ea(c, e)), u;
    }
    let l = {
      children: [],
      operator: o[0]
  ...
  return Ta(n) || (n = vf(n)), r(n);
}
function Kx(n, { ignoreFieldNorm: e = W.ignoreFieldNorm }) {
  n.forEach((t) => {
    let r = 1;
...
function qx(n, e) {
  const t = n.matches;
  e.matches = [], Qe(t) && t.forEach((r) => {
    if (!Qe(r.indices) || !r.indices.length)
      return;
...
function Gx(n, e, {
  ...
  const i = [];
  return t && i.push(qx), r && i.push(Jx), n.map((o) => {
    const { idx: s } = o, l = {
      item: e[s],
      refIndex: s
    };
...
class $r {
  constructor(e, t = {}, r) {
    this.options = { ...W, ...t }, this.options.useExtendedSearch, this._keyStore = new wx(this.options.keys), this.setCollection(e, r);
  }
  setCollection(e, t) {
  ...
  add(e) {
    !Qe(e) || (this._docs.push(e), this._myIndex.add(e));
  }
  remove(e = () => !1) {
    const t = [];
  ...
  search(e, { limit: t = -1 } = {}) {
    ...
    return Kx(a, { ignoreFieldNorm: l }), o && a.sort(s), Gh(t) && t > -1 && (a = a.slice(0, t)), Gx(a, this._docs, {
      includeMatches: r,
      includeScore: i
    });
  }
  _searchStringList(e) {
    const t = Ea(e, this.options), { records: r } = this._myIndex, i = [];
  ...
  _searchObjectList(e) {
    const t = Ea(e, this.options), { keys: r, records: i } = this._myIndex, o = [];
...
$r.parseQuery = rp;
jx(Vx);
const Yx = { class: "relative group-tooltip" }, Xx = ["innerHTML"], Qx = /* @__PURE__ */ ze({
  __name: "Tooltip",
  props: {
    value: {
      type: String,
...
}), Oa = /* @__PURE__ */ Zt(Qx, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/elements/Tooltip.vue"]]), Zx = { class: "block-menu" }, ek = { class: "text-left divide-y" }, tk = {
  key: 0,
  class: "block-menu-search px-2 py-2 flex gap-2 w-full"
}, nk = { class: "truncate" }, rk = {
  key: 1,
  class: "px-2 py-2"
}, ik = ["onClick", "onMouseover"], ok = { class: "truncate" }, sk = /* @__PURE__ */ ze({
  __name: "BlockMenu",
  props: {
    blockTypes: {
      type: Object,
  ...
  setup(n, { expose: e, emit: t }) {
    const r = n, i = t, o = Ze(!1);
    let s = !1;
    const l = Ze(null), a = Ze(null);
    wf(o, (p) => {
      p || (s = !1);
    ...
    const f = new $r(Os, {
      ...
      const p = u.value === "" ? Os : f.search(u.value).map((m) => m.item);
    ...
    return e({
      ...
      return me(), Ke("div", {
        ...
        We("div", {
          ...
          vt(Oa, { value: "<span class='text-neutral-400'><span class='text-white'>Drag</span> to move<br/><span class='text-white'>Click</span> to open menu</span>" }, {
            default: kr(() => [
              vt(g, {
...
}), lk = /* @__PURE__ */ Zt(sk, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/BlockMenu.vue"]]), ak = /* @__PURE__ */ ze({
  __name: "Block",
  props: {
    block: {
      type: Object,
  ...
  setup(n, { expose: e, emit: t }) {
    const r = n, i = t;
    function o() {
      return cn(r.block.type) ? (d.value.$el.firstChild.firstChild.childNodes.length > 1, d.value.$el.firstChild.firstChild.firstChild) : d.value.$el ? d.value.$el.firstChild || d.value.$el : d.value.firstChild || d.value;
    }
    function s() {
      return cn(r.block.type) ? d.value.$el.firstChild.firstChild.childNodes.length > 1 ? d.value.$el.firstChild.firstChild.lastChild : d.value.$el.firstChild.firstChild.firstChild : d.value.$el ? d.value.$el.firstChild || d.value.$el : d.value.firstChild || d.value;
    }
    function l() {
      return cn(r.block.type) ? d.value.$el.firstChild.firstChild.firstChild : d.value.$el.firstChild;
    }
    function a() {
      const x = l();
      return x ? x.parentElement ? x.parentElement.textContent : x.textContent : "";
    }
    function c() {
      const x = l();
      return x ? x.parentElement.innerHTML : "";
    }
    function u(x) {
      var S, M;
      x.key === "ArrowUp" ? (S = h.value) != null && S.open ? x.preventDefault() : g() && (x.preventDefault(), i("moveToPrevLine")) : x.key === "ArrowDown" ? (M = h.value) != null && M.open ? x.preventDefault() : v() && (x.preventDefault(), i("moveToNextLine")) : x.key === "ArrowLeft" ? p() && (x.preventDefault(), i("moveToPrevChar")) : x.key === "ArrowRight" ? m() && (x.preventDefault(), i("moveToNextChar")) : x.key === "Backspace" && w() === 0 ? !(h.value && h.value.open) && p() && (x.preventDefault(), i("merge")) : x.key === "Enter" && (x.preventDefault(), h.value && h.value.open || i("split"));
    }
    function f() {
      return [L.Text, L.Quote, L.H1, L.H2, L.H3].includes(r.block.type);
    }
    const d = Ze(null), h = Ze(null);
    function p() {
      const x = K(), S = A();
      return (S == null ? void 0 : S.x) === x.x && (S == null ? void 0 : S.y) === x.y;
    }
    function m() {
      const x = U(), S = A();
      return (S == null ? void 0 : S.x) === x.x && (S == null ? void 0 : S.y) === x.y;
    ...
    function w() {
      var x;
      return (x = window.getSelection()) == null ? void 0 : x.toString().length;
    }
    function E() {
      if (f()) {
        const x = o();
        if (x) {
          ...
          M.selectNodeContents(x), M.collapse(!0), S == null || S.removeAllRanges(), S == null || S.addRange(M);
        }
      } else
        i("moveToNextChar");
    }
    function y() {
      if (f()) {
        ...
        if (x) {
          const S = window.getSelection(), M = document.createRange();
          M.selectNodeContents(x), M.collapse(), S == null || S.removeAllRanges(), S == null || S.addRange(M);
        }
      } else
        i("moveToPrevChar");
    }
    async function T() {
      if (f()) {
        ...
        if (!x)
          ...
          for (; ; ) {
            $(I);
            const P = A(), Q = Math.abs((P == null ? void 0 : P.x) - (S == null ? void 0 : S.x));
            if (Q > M) {
              I > 0 && $(I - 1);
              break;
            } else {
    ...
    function _() {
      ...
      if (x)
        if (cn(r.block.type)) {
          ...
          return { pos: M + x.anchorOffset, tag: I };
        } else
          return { pos: x.anchorOffset };
      else
        return { pos: 0 };
    }
    function D() {
    ...
    function $(x) {
      ...
      if (S)
        if (cn(r.block.type)) {
          let M, I = 0;
          const P = d.value.$el.firstChild.firstChild.childNodes.length;
          for (const [Se, Ve] of d.value.$el.firstChild.firstChild.childNodes.entries()) {
            if (I + Ve.textContent.length > x || Se === P - 1) {
              M = Ve;
              break;
            }
          ...
          se.setStart(M.firstChild || M, x - I), se.setEnd(M.firstChild || M, x - I), Q == null || Q.removeAllRanges(), Q == null || Q.addRange(se);
        } else {
          const M = window.getSelection(), I = document.createRange();
          I.setStart(S, x), I.setEnd(S, x), M == null || M.removeAllRanges(), M == null || M.addRange(I);
        }
    }
    function K() {
      let x = 0, S = 0;
    ...
    function G(x) {
      ...
      S.match(M[L.H1]) && x.key === " " ? I(L.H1) : S.match(M[L.H2]) && x.key === " " ? I(L.H2) : S.match(M[L.H3]) && x.key === " " ? I(L.H3) : S.match(M[L.Quote]) && x.key === " " ? I(L.Quote) : S.match(M[L.Divider]) && x.key === " " ? (I(L.Divider), r.block.details.value = "") : x.key === "/" && h.value && !h.value.open && (h.value.open = !0, h.value.openedWithSlash = !0);
    }
    function Y(x, S, M = !1) {
      re(S, x, M).then((I) => {
        i("setBlockType", x), setTimeout(() => {
          S < 1 && !M ? y() : $(I);
        });
      });
    }
    async function re(x, S, M = !1) {
      const I = D().pos;
      let P = I - (x ? x + 1 : 0), Q = I;
    ...
    return e({
      ...
      return me(), Ke("div", {
        ...
        We("div", {
          ...
          vt(Oa, { value: "<span class='text-neutral-400'><span class='text-white'>Click</span> to delete block</span>" }, {
            default: kr(() => [
              vt(M, {
                name: "hi-trash",
          ...
          vt(Oa, { value: "<span class='text-neutral-400'><span class='text-white'>Click</span> to add block below</span>" }, {
            default: kr(() => [
              vt(M, {
                name: "hi-plus",
...
}), ck = /* @__PURE__ */ Zt(ak, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/Block.vue"]]), uk = ["contenteditable"], fk = /* @__PURE__ */ ze({
  __name: "Lotion",
  props: {
    page: {
      type: Object,
  ...
  setup(n) {
    ...
    document.addEventListener("mouseup", (f) => {
      var g, v;
      const d = document.getElementById("blocks"), h = document.getElementById("title"), p = (g = t.value) == null ? void 0 : g.getClientRects()[0];
      if (!d || !h || !p)
        return;
      if (f.clientX < (p.left || -1) || f.clientX > ((p == null ? void 0 : p.right) || window.innerWidth)) {
        const w = h == null ? void 0 : h.getClientRects()[0];
        if (f.clientY > ((w == null ? void 0 : w.top) || window.innerHeight) && f.clientY < ((w == null ? void 0 : w.bottom) || 0)) {
          const b = h == null ? void 0 : h.getClientRects()[0];
          let A = !0;
          f.x > b.right && (A = !1);
          const _ = window.getSelection(), D = document.createRange();
          D.selectNodeContents(h), D.collapse(A), _ == null || _.removeAllRanges(), _ == null || _.addRange(D);
          return;
        }
        const E = Array.from(d == null ? void 0 : d.children), y = E.find((b) => {
          const A = b.getClientRects()[0];
          return f.clientY > A.top && f.clientY < A.bottom;
        }), T = E.findIndex((b) => {
          const A = b.getClientRects()[0];
          return f.clientY > A.top && f.clientY < A.bottom;
        });
        if (y) {
          const b = y.getClientRects()[0];
          f.x < b.left ? i.value[T].moveToStart() : i.value[T].moveToEnd();
          return;
        }
      }
      const m = (v = d == null ? void 0 : d.lastElementChild) == null ? void 0 : v.getClientRects()[0];
      if (!!m && f.clientX > m.left && f.clientX < m.right && f.clientY > m.bottom) {
        const w = e.page.blocks[e.page.blocks.length - 1], E = i.value[e.page.blocks.length - 1];
        w.type === L.Text && E.getTextContent() === "" ? setTimeout(E.moveToEnd) : s(e.page.blocks.length - 1);
      }
    });
    const r = {
      animation: 150,
    ...
    function o() {
      ...
      !f || !f.anchorNode || (((d = f == null ? void 0 : f.anchorNode) == null ? void 0 : d.nodeType) === Node.ELEMENT_NODE ? (f == null ? void 0 : f.anchorNode).scrollIntoView({ behavior: "smooth", block: "center", inline: "nearest" }) : ((h = f == null ? void 0 : f.anchorNode) == null ? void 0 : h.parentElement).scrollIntoView({ behavior: "smooth", block: "center", inline: "nearest" }));
    }
    function s(f) {
      e.page.blocks.splice(f + 1, 0, {
        id: pm(),
        type: L.Text,
        details: {
          value: ""
        ...
        i.value[f + 1].moveToStart(), o();
      });
    }
    function l(f) {
      e.page.blocks.splice(f, 1), e.page.blocks.length === 0 && s(0);
    }
    async function a(f, d) {
      i.value[f].content.onUnset && i.value[f].content.onUnset(), e.page.blocks[f].type = d, d === L.Divider ? (e.page.blocks[f].details = {}, s(f)) : setTimeout(() => {
        i.value[f].content.onSet ? i.value[f].content.onSet() : i.value[f].moveToEnd();
      });
    }
    function c(f) {
      if ([L.H1, L.H2, L.H3, L.Quote].includes(e.page.blocks[f].type)) {
        a(f, L.Text), setTimeout(() => {
          i.value[f].moveToStart();
        });
        return;
      }
      if (f !== 0)
        if (cn(e.page.blocks[f - 1].type)) {
          const d = i.value[f - 1].getTextContent().length;
          e.page.blocks[f - 1].details.value = e.page.blocks[f - 1].details.value + e.page.blocks[f].details.value, setTimeout(() => {
            i.value[f - 1].setCaretPos(d), e.page.blocks.splice(f, 1);
          });
        } else if ([L.H1, L.H2, L.H3].includes(e.page.blocks[f - 1].type)) {
          const d = e.page.blocks[f - 1].details.value.length;
          e.page.blocks[f - 1].details.value += i.value[f].getTextContent(), setTimeout(() => {
            i.value[f - 1].setCaretPos(d), e.page.blocks.splice(f, 1);
          });
        } else
          e.page.blocks.splice(f - 1, 1), setTimeout(() => i.value[f - 1].moveToStart());
    }
    function u(f) {
      const d = i.value[f].getCaretPos();
      s(f);
      const h = i.value[f].getHtmlContent();
      e.page.blocks[f + 1].details.value = Ts((d.tag ? `<${d.tag}>` : "") + (h ? h == null ? void 0 : h.slice(d.pos) : "")), e.page.blocks[f].details.value = Ts((h ? h == null ? void 0 : h.slice(0, d.pos) : "") + (d.tag ? `</${d.tag}>` : "")), setTimeout(() => i.value[f + 1].moveToStart());
    }
    return (f, d) => e.page ? (me(), Ke("div", {
      key: 0,
      ...
      We("h1", {
        ...
        spellcheck: "false",
        "data-ph": "Untitled",
        onKeydown: d[0] || (d[0] = Fl((h) => h.preventDefault(), ["enter"])),
        onBlur: d[1] || (d[1] = (h) => e.page.name = h.target.innerText.replace(`
`, "")),
        class: wt(["focus:outline-none focus-visible:outline-none text-5xl font-bold mb-12", e.page.name ? "" : "empty"])
      }, Ao(e.page.name || ""), 43, uk),
      vt(he(am), xp({
        id: "blocks",
        tag: "div",
        list: e.page.blocks,
        handle: ".handle"
      }, r, { class: "-ml-24 space-y-2 pb-4" }), {
        default: kr(() => [
          vt(kp, { type: "transition" }, {
            default: kr(() => [
              (me(!0), Ke(xf, null, kf(e.page.blocks, (h, p) => (me(), Br(ck, {
                block: h,
                key: p,
                id: "block-" + h.id,
                ...
                onMoveToPrevChar: (m) => {
                  var g;
                  (g = i.value[p - 1]) == null || g.moveToEnd(), o();
                },
                onMoveToNextChar: (m) => {
                  var g;
                  (g = i.value[p + 1]) == null || g.moveToStart(), o();
                },
                onMoveToPrevLine: (m) => {
                  var g;
                  (g = i.value[p - 1]) == null || g.moveToLastLine(), o();
                },
                onMoveToNextLine: (m) => {
                  var g;
                  (g = i.value[p + 1]) == null || g.moveToFirstLine(), o();
                },
                onMerge: (m) => c(p),
                onSplit: (m) => u(p),
                onSetBlockType: (m) => a(p, m)
              }, null, 8, ["block", "id", "blockTypes", "readonly", "onDeleteBlock", "onNewBlock", "onMoveToPrevChar", "onMoveToNextChar", "onMoveToPrevLine", "onMoveToNextLine", "onMerge", "onSplit", "onSetBlockType"]))), 128))
            ]),
            _: 1
          })
        ]),
...
}), mk = /* @__PURE__ */ Zt(fk, [["__file", "/Users/matisiekpl/solidchatio/lotion/src/components/Lotion.vue"]]);
export {
  mk as Lotion,
  hk as registerBlock,
  pk as types
